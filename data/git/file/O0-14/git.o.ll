...
if.end:                                           ; preds = %lor.lhs.false
  ...
  %call1 = call i32 @check_pager_config(i8* noundef %1), !dbg !63
...
sw.bb:                                            ; preds = %entry
  %call = call i32 @"\01_setenv"(i8* noundef getelementptr inbounds ([10 x i8], [10 x i8]* @.str.15, i64 0, i64 0), i8* noundef getelementptr inbounds ([4 x i8], [4 x i8]* @.str.16, i64 0, i64 0), i32 noundef 1), !dbg !79
...
; Function Attrs: noinline nounwind ssp uwtable
define i32 @is_builtin(i8* noundef %s) #0 !dbg !86 {
entry:
  ...
  %call = call %struct.cmd_struct* @get_builtin(i8* noundef %0), !dbg !92
...
; Function Attrs: noinline nounwind ssp uwtable
define internal %struct.cmd_struct* @get_builtin(i8* noundef %s) #0 !dbg !96 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %call = call i32 @strcmp(i8* noundef %2, i8* noundef %4), !dbg !120
...
; Function Attrs: noinline nounwind ssp uwtable
define void @load_builtin_commands(i8* noundef %prefix, %struct.cmdnames* noundef %cmds) #0 !dbg !132 {
entry:
  ...
  %call = call i32 @skip_prefix(i8* noundef %0, i8* noundef getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i8** noundef %prefix.addr), !dbg !165
  %tobool = icmp ne i32 %call, 0, !dbg !165
  br i1 %tobool, label %if.end, label %if.then, !dbg !166

if.then:                                          ; preds = %entry
  %1 = load i8*, i8** %prefix.addr, align 8, !dbg !167
  call void (i8*, i32, i8*, ...) @BUG_fl(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 674, i8* noundef getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0), i8* noundef %1) #8, !dbg !167
  unreachable, !dbg !167
...
for.body:                                         ; preds = %for.cond
  ...
  %call2 = call i32 @skip_prefix(i8* noundef %4, i8* noundef %5, i8** noundef %name), !dbg !180
...
if.then4:                                         ; preds = %for.body
  ...
  %call5 = call i64 @strlen(i8* noundef %8), !dbg !185
  %conv6 = trunc i64 %call5 to i32, !dbg !185
  call void @add_cmdname(%struct.cmdnames* noundef %6, i8* noundef %7, i32 noundef %conv6), !dbg !186
...
; Function Attrs: noinline nounwind ssp uwtable
define internal i32 @skip_prefix(i8* noundef %str, i8* noundef %prefix, i8** noundef %out) #0 !dbg !193 {
entry:
...
; Function Attrs: noinline nounwind ssp uwtable
define i32 @cmd_main(i32 noundef %argc, i8** noundef %argv) #0 !dbg !224 {
entry:
...
if.else:                                          ; preds = %entry
  ...
  %call = call i8* @git_find_last_dir_sep(i8* noundef %3), !dbg !246
...
if.end3:                                          ; preds = %if.end, %if.then
  ...
  call void @trace_command_performance(i8** noundef %6), !dbg !255
  %7 = load i8*, i8** %cmd, align 8, !dbg !256
  %call4 = call i32 @skip_prefix(i8* noundef %7, i8* noundef getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i8** noundef %cmd), !dbg !258
...
if.then6:                                         ; preds = %if.end3
  ...
  call void @handle_builtin(i32 noundef %10, i8** noundef %11), !dbg !266
  %call8 = call i8* @_(i8* noundef getelementptr inbounds ([30 x i8], [30 x i8]* @.str.4, i64 0, i64 0)), !dbg !267
  %12 = load i8*, i8** %cmd, align 8, !dbg !268
  call void (i8*, ...) @die(i8* noundef %call8, i8* noundef %12) #8, !dbg !269
  unreachable, !dbg !269
...
if.end9:                                          ; preds = %if.end3
  ...
  %call10 = call i32 @handle_options(i8*** noundef %argv.addr, i32* noundef %argc.addr, i32* noundef null), !dbg !272
...
if.then12:                                        ; preds = %if.end9
  ...
  %call13 = call i8* @_(i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.5, i64 0, i64 0)), !dbg !278
  %call14 = call i32 (i8*, ...) @printf(i8* noundef %call13, i8* noundef getelementptr inbounds ([389 x i8], [389 x i8]* @git_usage_string, i64 0, i64 0)), !dbg !279
  call void @list_common_cmds_help(), !dbg !280
  %call15 = call i8* @_(i8* noundef getelementptr inbounds ([231 x i8], [231 x i8]* @git_more_info_string, i64 0, i64 0)), !dbg !281
  %call16 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([5 x i8], [5 x i8]* @.str.6, i64 0, i64 0), i8* noundef %call15), !dbg !282
  %call17 = call i32 @common_exit(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 907, i32 noundef 1), !dbg !283
  call void @exit(i32 noundef %call17) #8, !dbg !283
  unreachable, !dbg !283
...
if.end18:                                         ; preds = %if.end9
  ...
  %call20 = call i32 @strcmp(i8* noundef getelementptr inbounds ([10 x i8], [10 x i8]* @.str.7, i64 0, i64 0), i8* noundef %17), !dbg !286
...
lor.lhs.false:                                    ; preds = %if.end18
  ...
  %call23 = call i32 @strcmp(i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.8, i64 0, i64 0), i8* noundef %19), !dbg !289
...
if.else27:                                        ; preds = %lor.lhs.false
  ...
  %call29 = call i32 @strcmp(i8* noundef getelementptr inbounds ([7 x i8], [7 x i8]* @.str.10, i64 0, i64 0), i8* noundef %22), !dbg !295
...
lor.lhs.false31:                                  ; preds = %if.else27
  ...
  %call33 = call i32 @strcmp(i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.11, i64 0, i64 0), i8* noundef %24), !dbg !298
...
while.body:                                       ; preds = %if.end38, %if.end56
  ...
  %call40 = call i32 @run_argv(i32* noundef %argc.addr, i8*** noundef %argv.addr), !dbg !309
...
if.then45:                                        ; preds = %if.end43
  ...
  %call46 = call i8* @_(i8* noundef getelementptr inbounds ([59 x i8], [59 x i8]* @.str.13, i64 0, i64 0)), !dbg !320
  ...
  %call48 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* noundef %30, i8* noundef %call46, i8* noundef %31, i8* noundef %33), !dbg !323
  %call49 = call i32 @common_exit(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 933, i32 noundef 1), !dbg !324
  call void @exit(i32 noundef %call49) #8, !dbg !324
  unreachable, !dbg !324
...
if.then52:                                        ; preds = %if.end50
  ...
  %call53 = call i8* @help_unknown_cmd(i8* noundef %35), !dbg !330
...
while.end:                                        ; preds = %if.else55, %if.then42
  ...
  %call57 = call i8* @_(i8* noundef getelementptr inbounds ([32 x i8], [32 x i8]* @.str.14, i64 0, i64 0)), !dbg !340
  %38 = load i8*, i8** %cmd, align 8, !dbg !341
  %call58 = call i32* @__error(), !dbg !342
  %39 = load i32, i32* %call58, align 4, !dbg !342
  %call59 = call i8* @"\01_strerror"(i32 noundef %39), !dbg !343
  %call60 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* noundef %37, i8* noundef %call57, i8* noundef %38, i8* noundef %call59), !dbg !344
  ret i32 1, !dbg !345
}

; Function Attrs: noinline nounwind ssp uwtable
define internal i8* @git_find_last_dir_sep(i8* noundef %path) #0 !dbg !346 {
entry:
  ...
  %call = call i8* @strrchr(i8* noundef %0, i32 noundef 47), !dbg !352
  ret i8* %call, !dbg !353
}
...
; Function Attrs: noinline nounwind ssp uwtable
define internal void @handle_builtin(i32 noundef %argc, i8** noundef %argv) #0 !dbg !354 {
entry:
  %argc.addr = alloca i32, align 4
  %argv.addr = alloca i8**, align 8
...
land.lhs.true:                                    ; preds = %entry
  ...
  %call = call i32 @strcmp(i8* noundef %5, i8* noundef getelementptr inbounds ([7 x i8], [7 x i8]* @.str.10, i64 0, i64 0)), !dbg !380
...
for.body:                                         ; preds = %for.cond
  ...
  %call7 = call i8* @strvec_push(%struct.strvec* noundef %args, i8* noundef %14), !dbg !402
  %15 = load i32, i32* %i, align 4, !dbg !403
  %tobool8 = icmp ne i32 %15, 0, !dbg !403
  br i1 %tobool8, label %if.end, label %if.then9, !dbg !405

if.then9:                                         ; preds = %for.body
  %call10 = call i8* @strvec_push(%struct.strvec* noundef %args, i8* noundef getelementptr inbounds ([17 x i8], [17 x i8]* @.str.156, i64 0, i64 0)), !dbg !406
...
if.end12:                                         ; preds = %for.end, %land.lhs.true, %entry
  ...
  %call13 = call %struct.cmd_struct* @get_builtin(i8* noundef %19), !dbg !417
...
if.then15:                                        ; preds = %if.end12
  ...
  %call16 = call i32 @run_builtin(%struct.cmd_struct* noundef %21, i32 noundef %22, i8** noundef %23), !dbg !422
  %call17 = call i32 @common_exit(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 721, i32 noundef %call16), !dbg !422
  call void @exit(i32 noundef %call17) #8, !dbg !422
  unreachable, !dbg !422

if.end18:                                         ; preds = %if.end12
  call void @strvec_clear(%struct.strvec* noundef %args), !dbg !423
  ret void, !dbg !424
}

; Function Attrs: noinline nounwind ssp uwtable
define internal i8* @_(i8* noundef %msgid) #0 !dbg !425 {
entry:
...
if.end:                                           ; preds = %entry
  ...
  %call = call i8* @libintl_gettext(i8* noundef %2), !dbg !437
...
; Function Attrs: noinline nounwind ssp uwtable
define internal i32 @handle_options(i8*** noundef %argv, i32* noundef %argc, i32* noundef %envchanged) #0 !dbg !440 {
entry:
  %argv.addr = alloca i8***, align 8
...
if.end:                                           ; preds = %while.body
  ...
  %call = call i32 @strcmp(i8* noundef %9, i8* noundef getelementptr inbounds ([7 x i8], [7 x i8]* @.str.10, i64 0, i64 0)), !dbg !472
...
lor.lhs.false:                                    ; preds = %if.end
  ...
  %call4 = call i32 @strcmp(i8* noundef %10, i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.11, i64 0, i64 0)), !dbg !475
...
lor.lhs.false6:                                   ; preds = %lor.lhs.false
  ...
  %call7 = call i32 @strcmp(i8* noundef %11, i8* noundef getelementptr inbounds ([10 x i8], [10 x i8]* @.str.7, i64 0, i64 0)), !dbg !478
...
lor.lhs.false9:                                   ; preds = %lor.lhs.false6
  ...
  %call10 = call i32 @strcmp(i8* noundef %12, i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.8, i64 0, i64 0)), !dbg !481
...
if.end13:                                         ; preds = %lor.lhs.false9
  ...
  %call14 = call i32 @skip_prefix(i8* noundef %13, i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.164, i64 0, i64 0), i8** noundef %cmd), !dbg !486
...
if.then20:                                        ; preds = %if.then16
  ...
  call void @git_set_exec_path(i8* noundef %add.ptr), !dbg !496
  br label %if.end24, !dbg !496

if.else:                                          ; preds = %if.then16
  %call21 = call i8* @git_exec_path(), !dbg !497
  %call22 = call i32 @puts(i8* noundef %call21), !dbg !499
  call void @trace2_cmd_name_fl(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 161, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.165, i64 0, i64 0)), !dbg !500
  %call23 = call i32 @common_exit(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 162, i32 noundef 0), !dbg !501
  call void @exit(i32 noundef %call23) #8, !dbg !501
  unreachable, !dbg !501
...
if.else25:                                        ; preds = %if.end13
  ...
  %call26 = call i32 @strcmp(i8* noundef %17, i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.166, i64 0, i64 0)), !dbg !505
  %tobool27 = icmp ne i32 %call26, 0, !dbg !505
  br i1 %tobool27, label %if.else32, label %if.then28, !dbg !506

if.then28:                                        ; preds = %if.else25
  %call29 = call i8* @system_path(i8* noundef getelementptr inbounds ([18 x i8], [18 x i8]* @.str.167, i64 0, i64 0)), !dbg !507
  %call30 = call i32 @puts(i8* noundef %call29), !dbg !509
  call void @trace2_cmd_name_fl(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 166, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.165, i64 0, i64 0)), !dbg !510
  %call31 = call i32 @common_exit(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 167, i32 noundef 0), !dbg !511
  call void @exit(i32 noundef %call31) #8, !dbg !511
  unreachable, !dbg !511

if.else32:                                        ; preds = %if.else25
  %18 = load i8*, i8** %cmd, align 8, !dbg !512
  %call33 = call i32 @strcmp(i8* noundef %18, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @.str.168, i64 0, i64 0)), !dbg !514
  %tobool34 = icmp ne i32 %call33, 0, !dbg !514
  br i1 %tobool34, label %if.else39, label %if.then35, !dbg !515

if.then35:                                        ; preds = %if.else32
  %call36 = call i8* @system_path(i8* noundef getelementptr inbounds ([10 x i8], [10 x i8]* @.str.169, i64 0, i64 0)), !dbg !516
  %call37 = call i32 @puts(i8* noundef %call36), !dbg !518
  call void @trace2_cmd_name_fl(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 170, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.165, i64 0, i64 0)), !dbg !519
  %call38 = call i32 @common_exit(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 171, i32 noundef 0), !dbg !520
  call void @exit(i32 noundef %call38) #8, !dbg !520
  unreachable, !dbg !520

if.else39:                                        ; preds = %if.else32
  %19 = load i8*, i8** %cmd, align 8, !dbg !521
  %call40 = call i32 @strcmp(i8* noundef %19, i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.170, i64 0, i64 0)), !dbg !523
  %tobool41 = icmp ne i32 %call40, 0, !dbg !523
  br i1 %tobool41, label %if.else46, label %if.then42, !dbg !524

if.then42:                                        ; preds = %if.else39
  %call43 = call i8* @system_path(i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @.str.171, i64 0, i64 0)), !dbg !525
  %call44 = call i32 @puts(i8* noundef %call43), !dbg !527
  call void @trace2_cmd_name_fl(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 174, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.165, i64 0, i64 0)), !dbg !528
  %call45 = call i32 @common_exit(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 175, i32 noundef 0), !dbg !529
  call void @exit(i32 noundef %call45) #8, !dbg !529
  unreachable, !dbg !529

if.else46:                                        ; preds = %if.else39
  %20 = load i8*, i8** %cmd, align 8, !dbg !530
  %call47 = call i32 @strcmp(i8* noundef %20, i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.172, i64 0, i64 0)), !dbg !532
...
lor.lhs.false49:                                  ; preds = %if.else46
  ...
  %call50 = call i32 @strcmp(i8* noundef %21, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @.str.173, i64 0, i64 0)), !dbg !535
...
if.else53:                                        ; preds = %lor.lhs.false49
  ...
  %call54 = call i32 @strcmp(i8* noundef %22, i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.174, i64 0, i64 0)), !dbg !542
...
lor.lhs.false56:                                  ; preds = %if.else53
  ...
  %call57 = call i32 @strcmp(i8* noundef %23, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @.str.175, i64 0, i64 0)), !dbg !545
...
if.else63:                                        ; preds = %lor.lhs.false56
  ...
  %call64 = call i32 @strcmp(i8* noundef %26, i8* noundef getelementptr inbounds ([21 x i8], [21 x i8]* @.str.176, i64 0, i64 0)), !dbg !558
...
if.then66:                                        ; preds = %if.else63
  ...
  %call67 = call i32 @"\01_setenv"(i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @.str.177, i64 0, i64 0), i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.178, i64 0, i64 0), i32 noundef 1), !dbg !562
...
if.else71:                                        ; preds = %if.else63
  ...
  %call72 = call i32 @strcmp(i8* noundef %29, i8* noundef getelementptr inbounds ([10 x i8], [10 x i8]* @.str.179, i64 0, i64 0)), !dbg !572
...
if.then77:                                        ; preds = %if.then74
  ...
  %call78 = call i8* @_(i8* noundef getelementptr inbounds ([36 x i8], [36 x i8]* @.str.180, i64 0, i64 0)), !dbg !582
  %call79 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* noundef %32, i8* noundef %call78, i8* noundef getelementptr inbounds ([10 x i8], [10 x i8]* @.str.179, i64 0, i64 0)), !dbg !583
  call void @usage(i8* noundef getelementptr inbounds ([389 x i8], [389 x i8]* @git_usage_string, i64 0, i64 0)) #8, !dbg !584
  unreachable, !dbg !584
...
if.end80:                                         ; preds = %if.then74
  ...
  %call82 = call i32 @"\01_setenv"(i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.181, i64 0, i64 0), i8* noundef %35, i32 noundef 1), !dbg !588
...
if.else86:                                        ; preds = %if.else71
  ...
  %call87 = call i32 @skip_prefix(i8* noundef %42, i8* noundef getelementptr inbounds ([11 x i8], [11 x i8]* @.str.182, i64 0, i64 0), i8** noundef %cmd), !dbg !602
...
if.then89:                                        ; preds = %if.else86
  ...
  %call90 = call i32 @"\01_setenv"(i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.181, i64 0, i64 0), i8* noundef %43, i32 noundef 1), !dbg !606
...
if.else94:                                        ; preds = %if.else86
  ...
  %call95 = call i32 @strcmp(i8* noundef %46, i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.183, i64 0, i64 0)), !dbg !616
...
if.then100:                                       ; preds = %if.then97
  ...
  %call101 = call i8* @_(i8* noundef getelementptr inbounds ([36 x i8], [36 x i8]* @.str.184, i64 0, i64 0)), !dbg !626
  %call102 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* noundef %49, i8* noundef %call101), !dbg !627
  call void @usage(i8* noundef getelementptr inbounds ([389 x i8], [389 x i8]* @git_usage_string, i64 0, i64 0)) #8, !dbg !628
  unreachable, !dbg !628
...
if.end103:                                        ; preds = %if.then97
  ...
  %call105 = call i32 @"\01_setenv"(i8* noundef getelementptr inbounds ([14 x i8], [14 x i8]* @.str.185, i64 0, i64 0), i8* noundef %52, i32 noundef 1), !dbg !632
...
if.else111:                                       ; preds = %if.else94
  ...
  %call112 = call i32 @skip_prefix(i8* noundef %59, i8* noundef getelementptr inbounds ([13 x i8], [13 x i8]* @.str.186, i64 0, i64 0), i8** noundef %cmd), !dbg !646
...
if.then114:                                       ; preds = %if.else111
  ...
  %call115 = call i32 @"\01_setenv"(i8* noundef getelementptr inbounds ([14 x i8], [14 x i8]* @.str.185, i64 0, i64 0), i8* noundef %60, i32 noundef 1), !dbg !650
...
if.else119:                                       ; preds = %if.else111
  ...
  %call120 = call i32 @strcmp(i8* noundef %63, i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.187, i64 0, i64 0)), !dbg !660
...
if.then125:                                       ; preds = %if.then122
  ...
  %call126 = call i8* @_(i8* noundef getelementptr inbounds ([36 x i8], [36 x i8]* @.str.180, i64 0, i64 0)), !dbg !670
  %call127 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* noundef %66, i8* noundef %call126, i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @.str.187, i64 0, i64 0)), !dbg !671
  call void @usage(i8* noundef getelementptr inbounds ([389 x i8], [389 x i8]* @git_usage_string, i64 0, i64 0)) #8, !dbg !672
  unreachable, !dbg !672
...
if.end128:                                        ; preds = %if.then122
  ...
  %call130 = call i32 @"\01_setenv"(i8* noundef getelementptr inbounds ([14 x i8], [14 x i8]* @.str.188, i64 0, i64 0), i8* noundef %69, i32 noundef 1), !dbg !676
...
if.else136:                                       ; preds = %if.else119
  ...
  %call137 = call i32 @skip_prefix(i8* noundef %76, i8* noundef getelementptr inbounds ([13 x i8], [13 x i8]* @.str.189, i64 0, i64 0), i8** noundef %cmd), !dbg !690
...
if.then139:                                       ; preds = %if.else136
  ...
  %call140 = call i32 @"\01_setenv"(i8* noundef getelementptr inbounds ([14 x i8], [14 x i8]* @.str.188, i64 0, i64 0), i8* noundef %77, i32 noundef 1), !dbg !694
...
if.else144:                                       ; preds = %if.else136
  ...
  %call145 = call i32 @strcmp(i8* noundef %80, i8* noundef getelementptr inbounds ([15 x i8], [15 x i8]* @.str.190, i64 0, i64 0)), !dbg !704
...
if.then150:                                       ; preds = %if.then147
  ...
  %call151 = call i8* @_(i8* noundef getelementptr inbounds ([36 x i8], [36 x i8]* @.str.191, i64 0, i64 0)), !dbg !714
  %call152 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* noundef %83, i8* noundef %call151), !dbg !715
  call void @usage(i8* noundef getelementptr inbounds ([389 x i8], [389 x i8]* @git_usage_string, i64 0, i64 0)) #8, !dbg !716
  unreachable, !dbg !716
...
if.end153:                                        ; preds = %if.then147
  ...
  %call155 = call i32 @"\01_setenv"(i8* noundef getelementptr inbounds ([26 x i8], [26 x i8]* @.str.192, i64 0, i64 0), i8* noundef %86, i32 noundef 1), !dbg !720
...
if.else161:                                       ; preds = %if.else144
  ...
  %call162 = call i32 @skip_prefix(i8* noundef %93, i8* noundef getelementptr inbounds ([16 x i8], [16 x i8]* @.str.193, i64 0, i64 0), i8** noundef %cmd), !dbg !734
...
if.then164:                                       ; preds = %if.else161
  ...
  %call165 = call i32 @"\01_setenv"(i8* noundef getelementptr inbounds ([26 x i8], [26 x i8]* @.str.192, i64 0, i64 0), i8* noundef %94, i32 noundef 1), !dbg !738
...
if.else169:                                       ; preds = %if.else161
  ...
  %call170 = call i32 @strcmp(i8* noundef %97, i8* noundef getelementptr inbounds ([7 x i8], [7 x i8]* @.str.194, i64 0, i64 0)), !dbg !748
...
if.then172:                                       ; preds = %if.else169
  ...
  %call174 = call i32 @"\01_setenv"(i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.181, i64 0, i64 0), i8* noundef %98, i32 noundef 0), !dbg !756
  %99 = load i8*, i8** %cwd, align 8, !dbg !757
  call void @free(i8* noundef %99), !dbg !758
  %call175 = call i32 @"\01_setenv"(i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @.str.195, i64 0, i64 0), i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.196, i64 0, i64 0), i32 noundef 1), !dbg !759
...
if.else179:                                       ; preds = %if.else169
  ...
  %call180 = call i32 @strcmp(i8* noundef %102, i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.197, i64 0, i64 0)), !dbg !769
...
if.then185:                                       ; preds = %if.then182
  ...
  %call186 = call i8* @_(i8* noundef getelementptr inbounds ([35 x i8], [35 x i8]* @.str.198, i64 0, i64 0)), !dbg !779
  %call187 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* noundef %105, i8* noundef %call186), !dbg !780
  call void @usage(i8* noundef getelementptr inbounds ([389 x i8], [389 x i8]* @git_usage_string, i64 0, i64 0)) #8, !dbg !781
  unreachable, !dbg !781
...
if.end188:                                        ; preds = %if.then182
  ...
  call void @git_config_push_parameter(i8* noundef %108), !dbg !785
...
if.else192:                                       ; preds = %if.else179
  ...
  %call193 = call i32 @strcmp(i8* noundef %113, i8* noundef getelementptr inbounds ([13 x i8], [13 x i8]* @.str.199, i64 0, i64 0)), !dbg !793
...
if.then198:                                       ; preds = %if.then195
  ...
  %call199 = call i8* @_(i8* noundef getelementptr inbounds ([38 x i8], [38 x i8]* @.str.200, i64 0, i64 0)), !dbg !803
  %call200 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* noundef %116, i8* noundef %call199), !dbg !804
  call void @usage(i8* noundef getelementptr inbounds ([389 x i8], [389 x i8]* @git_usage_string, i64 0, i64 0)) #8, !dbg !805
  unreachable, !dbg !805
...
if.end201:                                        ; preds = %if.then195
  ...
  call void @git_config_push_env(i8* noundef %119), !dbg !809
...
if.else205:                                       ; preds = %if.else192
  ...
  %call206 = call i32 @skip_prefix(i8* noundef %124, i8* noundef getelementptr inbounds ([14 x i8], [14 x i8]* @.str.201, i64 0, i64 0), i8** noundef %cmd), !dbg !817
...
if.then208:                                       ; preds = %if.else205
  ...
  call void @git_config_push_env(i8* noundef %125), !dbg !821
  br label %if.end320, !dbg !822

if.else209:                                       ; preds = %if.else205
  %126 = load i8*, i8** %cmd, align 8, !dbg !823
  %call210 = call i32 @strcmp(i8* noundef %126, i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str.202, i64 0, i64 0)), !dbg !825
...
if.then212:                                       ; preds = %if.else209
  %call213 = call i32 @"\01_setenv"(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.203, i64 0, i64 0), i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.178, i64 0, i64 0), i32 noundef 1), !dbg !827
...
if.else217:                                       ; preds = %if.else209
  ...
  %call218 = call i32 @strcmp(i8* noundef %129, i8* noundef getelementptr inbounds ([23 x i8], [23 x i8]* @.str.204, i64 0, i64 0)), !dbg !838
...
if.then220:                                       ; preds = %if.else217
  %call221 = call i32 @"\01_setenv"(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.203, i64 0, i64 0), i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.196, i64 0, i64 0), i32 noundef 1), !dbg !840
...
if.else225:                                       ; preds = %if.else217
  ...
  %call226 = call i32 @strcmp(i8* noundef %132, i8* noundef getelementptr inbounds ([17 x i8], [17 x i8]* @.str.205, i64 0, i64 0)), !dbg !851
...
if.then228:                                       ; preds = %if.else225
  %call229 = call i32 @"\01_setenv"(i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @.str.206, i64 0, i64 0), i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.178, i64 0, i64 0), i32 noundef 1), !dbg !853
...
if.else233:                                       ; preds = %if.else225
  ...
  %call234 = call i32 @strcmp(i8* noundef %135, i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @.str.207, i64 0, i64 0)), !dbg !864
...
if.then236:                                       ; preds = %if.else233
  %call237 = call i32 @"\01_setenv"(i8* noundef getelementptr inbounds ([21 x i8], [21 x i8]* @.str.208, i64 0, i64 0), i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.178, i64 0, i64 0), i32 noundef 1), !dbg !866
...
if.else241:                                       ; preds = %if.else233
  ...
  %call242 = call i32 @strcmp(i8* noundef %138, i8* noundef getelementptr inbounds ([18 x i8], [18 x i8]* @.str.209, i64 0, i64 0)), !dbg !877
...
if.then244:                                       ; preds = %if.else241
  %call245 = call i32 @"\01_setenv"(i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str.210, i64 0, i64 0), i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.178, i64 0, i64 0), i32 noundef 1), !dbg !879
...
if.else249:                                       ; preds = %if.else241
  ...
  %call250 = call i32 @strcmp(i8* noundef %141, i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str.211, i64 0, i64 0)), !dbg !890
...
if.then252:                                       ; preds = %if.else249
  %call253 = call i32 @"\01_setenv"(i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @.str.212, i64 0, i64 0), i8* noundef getelementptr inbounds ([2 x i8], [2 x i8]* @.str.196, i64 0, i64 0), i32 noundef 1), !dbg !892
...
if.else257:                                       ; preds = %if.else249
  ...
  %call258 = call i32 @strcmp(i8* noundef %144, i8* noundef getelementptr inbounds ([15 x i8], [15 x i8]* @.str.213, i64 0, i64 0)), !dbg !903
...
if.then260:                                       ; preds = %if.else257
  ...
  call void @set_alternate_shallow_file(%struct.repository* noundef %149, i8* noundef %152, i32 noundef 1), !dbg !914
...
if.else267:                                       ; preds = %if.else257
  ...
  %call268 = call i32 @strcmp(i8* noundef %155, i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.214, i64 0, i64 0)), !dbg !924
...
if.then273:                                       ; preds = %if.then270
  ...
  %call274 = call i8* @_(i8* noundef getelementptr inbounds ([36 x i8], [36 x i8]* @.str.180, i64 0, i64 0)), !dbg !934
  %call275 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* noundef %158, i8* noundef %call274, i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.214, i64 0, i64 0)), !dbg !935
  call void @usage(i8* noundef getelementptr inbounds ([389 x i8], [389 x i8]* @git_usage_string, i64 0, i64 0)) #8, !dbg !936
  unreachable, !dbg !936
...
if.then280:                                       ; preds = %if.end276
  ...
  %call282 = call i32 @chdir(i8* noundef %165), !dbg !947
...
if.then284:                                       ; preds = %if.then280
  ...
  call void (i8*, ...) @die_errno(i8* noundef getelementptr inbounds ([22 x i8], [22 x i8]* @.str.215, i64 0, i64 0), i8* noundef %168) #8, !dbg !952
  unreachable, !dbg !952
...
if.else293:                                       ; preds = %if.else267
  ...
  %call294 = call i32 @skip_prefix(i8* noundef %175, i8* noundef getelementptr inbounds ([13 x i8], [13 x i8]* @.str.216, i64 0, i64 0), i8** noundef %cmd), !dbg !967
...
if.then296:                                       ; preds = %if.else293
  call void @trace2_cmd_name_fl(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 313, i8* noundef getelementptr inbounds ([8 x i8], [8 x i8]* @.str.165, i64 0, i64 0)), !dbg !969
  %176 = load i8*, i8** %cmd, align 8, !dbg !971
  %call297 = call i32 @strcmp(i8* noundef %176, i8* noundef getelementptr inbounds ([9 x i8], [9 x i8]* @.str.217, i64 0, i64 0)), !dbg !973
...
if.then299:                                       ; preds = %if.then296
  ...
  call void @list_builtins(%struct.string_list* noundef %list, i32 noundef 64), !dbg !998
...
for.body:                                         ; preds = %for.cond
  ...
  %call304 = call i32 (i8*, ...) @printf(i8* noundef getelementptr inbounds ([4 x i8], [4 x i8]* @.str.218, i64 0, i64 0), i8* noundef %184), !dbg !1011
...
for.end:                                          ; preds = %for.cond
  call void @string_list_clear(%struct.string_list* noundef %list, i32 noundef 0), !dbg !1016
  %call305 = call i32 @common_exit(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 322, i32 noundef 0), !dbg !1017
  call void @exit(i32 noundef %call305) #8, !dbg !1017
  unreachable, !dbg !1017

if.else306:                                       ; preds = %if.then296
  %186 = load i8*, i8** %cmd, align 8, !dbg !1018
  %call307 = call i32 @list_cmds(i8* noundef %186), !dbg !1018
  %call308 = call i32 @common_exit(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 324, i32 noundef %call307), !dbg !1018
  call void @exit(i32 noundef %call308) #8, !dbg !1018
  unreachable, !dbg !1018

if.else309:                                       ; preds = %if.else293
  %187 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 8, !dbg !1020
  %call310 = call i8* @_(i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str.219, i64 0, i64 0)), !dbg !1022
  %188 = load i8*, i8** %cmd, align 8, !dbg !1023
  %call311 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* noundef %187, i8* noundef %call310, i8* noundef %188), !dbg !1024
  call void @usage(i8* noundef getelementptr inbounds ([389 x i8], [389 x i8]* @git_usage_string, i64 0, i64 0)) #8, !dbg !1025
...
; Function Attrs: noinline nounwind ssp uwtable
define internal i32 @run_argv(i32* noundef %argcp, i8*** noundef %argv) #0 !dbg !1038 {
entry:
...
if.then:                                          ; preds = %while.body
  ...
  call void @handle_builtin(i32 noundef %3, i8** noundef %5), !dbg !1060
...
if.else:                                          ; preds = %while.body
  ...
  %call = call %struct.cmd_struct* @get_builtin(i8* noundef %8), !dbg !1065
...
if.then2:                                         ; preds = %if.else
  ...
  call void @trace2_cmd_name_fl(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 800, i8* noundef getelementptr inbounds ([16 x i8], [16 x i8]* @.str.228, i64 0, i64 0)), !dbg !1109
...
if.then5:                                         ; preds = %if.then2
  ...
  call void (i8*, ...) @die(i8* noundef getelementptr inbounds ([34 x i8], [34 x i8]* @.str.158, i64 0, i64 0), i8* noundef %17) #8, !dbg !1116
...
if.end:                                           ; preds = %if.then2
  ...
  %call6 = call i8* @strvec_push(%struct.strvec* noundef %args, i8* noundef getelementptr inbounds ([4 x i8], [4 x i8]* @.str.229, i64 0, i64 0)), !dbg !1119
...
for.body:                                         ; preds = %for.cond
  ...
  %call8 = call i8* @strvec_push(%struct.strvec* noundef %args7, i8* noundef %24), !dbg !1134
...
do.body:                                          ; preds = %for.end
  %call9 = call i32 @trace_pass_fl(%struct.trace_key* noundef @trace_default_key), !dbg !1140
...
if.then11:                                        ; preds = %do.body
  ...
  call void (i8*, i32, i8**, i8*, ...) @trace_argv_printf_fl(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 811, i8** noundef %26, i8* noundef getelementptr inbounds ([13 x i8], [13 x i8]* @.str.230, i64 0, i64 0)), !dbg !1140
...
do.end:                                           ; preds = %if.end13
  ...
  %call20 = call i32 @run_command(%struct.child_process* noundef %cmd), !dbg !1152
...
if.then24:                                        ; preds = %lor.lhs.false, %do.end
  ...
  %call25 = call i32 @common_exit(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 823, i32 noundef %29), !dbg !1161
  call void @exit(i32 noundef %call25) #8, !dbg !1161
...
if.end26:                                         ; preds = %lor.lhs.false
  ...
  call void (i8*, ...) @die(i8* noundef getelementptr inbounds ([29 x i8], [29 x i8]* @.str.232, i64 0, i64 0), i8* noundef %32) #8, !dbg !1165
...
if.end28:                                         ; preds = %if.end27, %if.then
  ...
  call void @execv_dashed_external(i8** noundef %34), !dbg !1168
  ...
  %call30 = call %struct.string_list_item* @unsorted_string_list_lookup(%struct.string_list* noundef %cmd_list, i8* noundef %37), !dbg !1171
...
for.body37:                                       ; preds = %for.cond34
  ...
  call void (%struct.strbuf*, i8*, ...) @strbuf_addf(%struct.strbuf* noundef %sb, i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.233, i64 0, i64 0), i8* noundef %45), !dbg !1203
...
if.then42:                                        ; preds = %for.body37
  call void @strbuf_addstr(%struct.strbuf* noundef %sb, i8* noundef getelementptr inbounds ([5 x i8], [5 x i8]* @.str.234, i64 0, i64 0)), !dbg !1209
...
if.then48:                                        ; preds = %if.else43
  call void @strbuf_addstr(%struct.strbuf* noundef %sb, i8* noundef getelementptr inbounds ([5 x i8], [5 x i8]* @.str.235, i64 0, i64 0)), !dbg !1216
...
for.end53:                                        ; preds = %for.cond34
  %call54 = call i8* @_(i8* noundef getelementptr inbounds ([61 x i8], [61 x i8]* @.str.236, i64 0, i64 0)), !dbg !1222
  ...
  call void (i8*, ...) @die(i8* noundef %call54, i8* noundef %52, i8* noundef %53) #8, !dbg !1227
...
if.end58:                                         ; preds = %if.end28
  ...
  %call60 = call %struct.string_list_item* @string_list_append(%struct.string_list* noundef %cmd_list, i8* noundef %56), !dbg !1230
  %57 = load i32*, i32** %argcp.addr, align 8, !dbg !1231
  %58 = load i8***, i8**** %argv.addr, align 8, !dbg !1233
  %call61 = call i32 @handle_alias(i32* noundef %57, i8*** noundef %58), !dbg !1234
...
while.end:                                        ; preds = %if.then63
  call void @string_list_clear(%struct.string_list* noundef %cmd_list, i32 noundef 0), !dbg !1240
...
; Function Attrs: noinline nounwind ssp uwtable
define internal i32 @trace_pass_fl(%struct.trace_key* noundef %key) #0 !dbg !1243 {
entry:
...
; Function Attrs: noinline nounwind ssp uwtable
define internal void @execv_dashed_external(i8** noundef %argv) #0 !dbg !1264 {
entry:
  %argv.addr = alloca i8**, align 8
  %cmd = alloca %struct.child_process, align 8
...
if.then:                                          ; preds = %entry
  %call1 = call i8* @_(i8* noundef getelementptr inbounds ([34 x i8], [34 x i8]* @.str.158, i64 0, i64 0)), !dbg !1276
  ...
  call void (i8*, ...) @die(i8* noundef %call1, i8* noundef %7) #8, !dbg !1278
...
land.lhs.true:                                    ; preds = %if.end
  ...
  %call3 = call i32 @is_builtin(i8* noundef %10), !dbg !1284
...
if.then5:                                         ; preds = %land.lhs.true
  ...
  %call7 = call i32 @check_pager_config(i8* noundef %12), !dbg !1287
...
if.end8:                                          ; preds = %if.then5, %land.lhs.true, %if.end
  ...
  %call10 = call i8* (%struct.strvec*, i8*, ...) @strvec_pushf(%struct.strvec* noundef %args, i8* noundef getelementptr inbounds ([7 x i8], [7 x i8]* @.str.237, i64 0, i64 0), i8* noundef %14), !dbg !1293
  ...
  call void @strvec_pushv(%struct.strvec* noundef %args11, i8** noundef %add.ptr), !dbg !1297
  ...
  call void @trace2_cmd_name_fl(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 744, i8* noundef getelementptr inbounds ([13 x i8], [13 x i8]* @.str.239, i64 0, i64 0)), !dbg !1306
  br label %do.body, !dbg !1307

do.body:                                          ; preds = %if.end8
  %call18 = call i32 @trace_pass_fl(%struct.trace_key* noundef @trace_default_key), !dbg !1308
...
if.then20:                                        ; preds = %do.body
  ...
  call void (i8*, i32, i8**, i8*, ...) @trace_argv_printf_fl(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 750, i8** noundef %16, i8* noundef getelementptr inbounds ([13 x i8], [13 x i8]* @.str.230, i64 0, i64 0)), !dbg !1308
...
do.end:                                           ; preds = %if.end22
  %call23 = call i32 @run_command(%struct.child_process* noundef %cmd), !dbg !1312
...
if.then25:                                        ; preds = %do.end
  ...
  %call26 = call i32 @common_exit(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 766, i32 noundef %18), !dbg !1318
  call void @exit(i32 noundef %call26) #8, !dbg !1318
...
if.then29:                                        ; preds = %if.else
  %call30 = call i32 @common_exit(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 768, i32 noundef 128), !dbg !1323
  call void @exit(i32 noundef %call30) #8, !dbg !1323
...
; Function Attrs: noinline nounwind ssp uwtable
define internal void @strbuf_addstr(%struct.strbuf* noundef %sb, i8* noundef %s) #0 !dbg !1325 {
entry:
  ...
  %call = call i64 @strlen(i8* noundef %2), !dbg !1336
  call void @strbuf_add(%struct.strbuf* noundef %0, i8* noundef %1, i64 noundef %call), !dbg !1337
  ret void, !dbg !1338
}
...
; Function Attrs: noinline nounwind ssp uwtable
define internal i32 @handle_alias(i32* noundef %argcp, i8*** noundef %argv) #0 !dbg !1339 {
entry:
  %argcp.addr = alloca i32*, align 8
  %argv.addr = alloca i8***, align 8
  ...
  %call1 = call i8* @alias_lookup(i8* noundef %4), !dbg !1366
...
land.lhs.true:                                    ; preds = %if.then
  ...
  %call3 = call i32 @strcmp(i8* noundef %10, i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.11, i64 0, i64 0)), !dbg !1380
...
if.then5:                                         ; preds = %land.lhs.true
  ...
  %call6 = call i8* @_(i8* noundef getelementptr inbounds ([24 x i8], [24 x i8]* @.str.240, i64 0, i64 0)), !dbg !1383
  %12 = load i8*, i8** %alias_command, align 8, !dbg !1384
  %13 = load i8*, i8** %alias_string, align 8, !dbg !1385
  %call7 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf_ln(%struct.__sFILE* noundef %11, i8* noundef %call6, i8* noundef %12, i8* noundef %13), !dbg !1386
...
if.then11:                                        ; preds = %if.end
  ...
  %call12 = call i8* @setup_git_directory_gently(i32* noundef %nongit_ok), !dbg !1396
  ...
  %call19 = call i8* @strvec_push(%struct.strvec* noundef %args, i8* noundef %add.ptr), !dbg !1409
  ...
  call void @strvec_pushv(%struct.strvec* noundef %args20, i8** noundef %add.ptr21), !dbg !1414
  ...
  call void @trace2_cmd_alias_fl(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 367, i8* noundef %25, i8** noundef %26), !dbg !1415
  call void @trace2_cmd_list_config_fl(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 368), !dbg !1416
  call void @trace2_cmd_list_env_vars_fl(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 369), !dbg !1417
  call void @trace2_cmd_name_fl(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 370, i8* noundef getelementptr inbounds ([18 x i8], [18 x i8]* @.str.242, i64 0, i64 0)), !dbg !1418
  %call23 = call i32 @run_command(%struct.child_process* noundef %child), !dbg !1419
...
if.then26:                                        ; preds = %if.then11
  ...
  %call27 = call i32 @common_exit(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 374, i32 noundef %28), !dbg !1425
  call void @exit(i32 noundef %call27) #8, !dbg !1425
  unreachable, !dbg !1425

if.end28:                                         ; preds = %if.then11
  %call29 = call i8* @_(i8* noundef getelementptr inbounds ([33 x i8], [33 x i8]* @.str.243, i64 0, i64 0)), !dbg !1426
  ...
  call void (i8*, ...) @die_errno(i8* noundef %call29, i8* noundef %29, i8* noundef %add.ptr30) #8, !dbg !1430
  unreachable, !dbg !1430

if.end31:                                         ; preds = %if.end
  %31 = load i8*, i8** %alias_string, align 8, !dbg !1431
  %call32 = call i32 @split_cmdline(i8* noundef %31, i8*** noundef %new_argv), !dbg !1432
...
if.then35:                                        ; preds = %if.end31
  %call36 = call i8* @_(i8* noundef getelementptr inbounds ([24 x i8], [24 x i8]* @.str.244, i64 0, i64 0)), !dbg !1438
  %33 = load i8*, i8** %alias_command, align 8, !dbg !1439
  %34 = load i32, i32* %count, align 4, !dbg !1440
  %call37 = call i8* @split_cmdline_strerror(i32 noundef %34), !dbg !1441
  %call38 = call i8* @_(i8* noundef %call37), !dbg !1442
  call void (i8*, ...) @die(i8* noundef %call36, i8* noundef %33, i8* noundef %call38) #8, !dbg !1443
  unreachable, !dbg !1443

if.end39:                                         ; preds = %if.end31
  %call40 = call i32 @handle_options(i8*** noundef %new_argv, i32* noundef %count, i32* noundef %envchanged), !dbg !1444
...
if.then42:                                        ; preds = %if.end39
  %call43 = call i8* @_(i8* noundef getelementptr inbounds ([85 x i8], [85 x i8]* @.str.245, i64 0, i64 0)), !dbg !1449
  %36 = load i8*, i8** %alias_command, align 8, !dbg !1450
  call void (i8*, ...) @die(i8* noundef %call43, i8* noundef %36) #8, !dbg !1451
...
if.end44:                                         ; preds = %if.end39
  ...
  call void @move_array(i8* noundef %39, i8* noundef %41, i64 noundef %conv46, i64 noundef 8), !dbg !1452
...
if.then52:                                        ; preds = %if.end44
  %call53 = call i8* @_(i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @.str.246, i64 0, i64 0)), !dbg !1459
  %46 = load i8*, i8** %alias_command, align 8, !dbg !1460
  call void (i8*, ...) @die(i8* noundef %call53, i8* noundef %46) #8, !dbg !1461
...
if.end54:                                         ; preds = %if.end44
  ...
  %call56 = call i32 @strcmp(i8* noundef %47, i8* noundef %49), !dbg !1465
  %tobool57 = icmp ne i32 %call56, 0, !dbg !1465
  br i1 %tobool57, label %if.end60, label %if.then58, !dbg !1466

if.then58:                                        ; preds = %if.end54
  %call59 = call i8* @_(i8* noundef getelementptr inbounds ([20 x i8], [20 x i8]* @.str.247, i64 0, i64 0)), !dbg !1467
  %50 = load i8*, i8** %alias_command, align 8, !dbg !1468
  call void (i8*, ...) @die(i8* noundef %call59, i8* noundef %50) #8, !dbg !1469
...
do.body:                                          ; preds = %if.end60
  %call61 = call i32 @trace_pass_fl(%struct.trace_key* noundef @trace_default_key), !dbg !1471
...
if.then63:                                        ; preds = %do.body
  ...
  call void (i8*, i32, i8**, i8*, ...) @trace_argv_printf_fl(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 399, i8** noundef %51, i8* noundef getelementptr inbounds ([30 x i8], [30 x i8]* @.str.248, i64 0, i64 0), i8* noundef %52), !dbg !1471
...
do.end:                                           ; preds = %if.end64
  ...
  %call66 = call i64 @st_mult(i64 noundef 8, i64 noundef %conv65), !dbg !1475
  %call67 = call i8* @xrealloc(i8* noundef %54, i64 noundef %call66), !dbg !1475
  ...
  call void @copy_array(i8* noundef %61, i8* noundef %64, i64 noundef %conv71, i64 noundef 8), !dbg !1476
  %67 = load i8*, i8** %alias_command, align 8, !dbg !1477
  %68 = load i8**, i8*** %new_argv, align 8, !dbg !1477
  call void @trace2_cmd_alias_fl(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 405, i8* noundef %67, i8** noundef %68), !dbg !1477
  call void @trace2_cmd_list_config_fl(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 406), !dbg !1478
  call void @trace2_cmd_list_env_vars_fl(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 407), !dbg !1479
...
; Function Attrs: noinline nounwind ssp uwtable
define internal void @move_array(i8* noundef %dst, i8* noundef %src, i64 noundef %n, i64 noundef %size) #0 !dbg !1494 {
entry:
...
if.then:                                          ; preds = %entry
  ...
  %call = call i64 @st_mult(i64 noundef %3, i64 noundef %4), !dbg !1510
  %5 = load i8*, i8** %dst.addr, align 8, !dbg !1510
  %6 = call i64 @llvm.objectsize.i64.p0i8(i8* %5, i1 false, i1 true, i1 false), !dbg !1510
  %call1 = call i8* @__memmove_chk(i8* noundef %1, i8* noundef %2, i64 noundef %call, i64 noundef %6) #9, !dbg !1510
...
; Function Attrs: noinline nounwind ssp uwtable
define internal i64 @st_mult(i64 noundef %a, i64 noundef %b) #0 !dbg !1512 {
entry:
...
if.then:                                          ; preds = %land.lhs.true
  ...
  call void (i8*, ...) @die(i8* noundef getelementptr inbounds ([27 x i8], [27 x i8]* @.str.249, i64 0, i64 0), i64 noundef %3, i64 noundef %4) #8, !dbg !1524
...
; Function Attrs: noinline nounwind ssp uwtable
define internal void @copy_array(i8* noundef %dst, i8* noundef %src, i64 noundef %n, i64 noundef %size) #0 !dbg !1529 {
entry:
  %dst.addr = alloca i8*, align 8
  %src.addr = alloca i8*, align 8
  %n.addr = alloca i64, align 8
...
if.then:                                          ; preds = %entry
  ...
  %call = call i64 @st_mult(i64 noundef %3, i64 noundef %4), !dbg !1541
  %5 = load i8*, i8** %dst.addr, align 8, !dbg !1541
  %6 = call i64 @llvm.objectsize.i64.p0i8(i8* %5, i1 false, i1 true, i1 false), !dbg !1541
  %call1 = call i8* @__memcpy_chk(i8* noundef %1, i8* noundef %2, i64 noundef %call, i64 noundef %6) #9, !dbg !1541
...
; Function Attrs: noinline nounwind ssp uwtable
define internal void @list_builtins(%struct.string_list* noundef %out, i32 noundef %exclude_option) #0 !dbg !1543 {
entry:
...
if.end:                                           ; preds = %land.lhs.true, %for.body
  ...
  %call = call %struct.string_list_item* @string_list_append(%struct.string_list* noundef %5, i8* noundef %7), !dbg !1575
...
; Function Attrs: noinline nounwind ssp uwtable
define internal i32 @list_cmds(i8* noundef %spec) #0 !dbg !1582 {
entry:
  ...
  %call = call i8* @setup_git_directory_gently(i32* noundef %nongit), !dbg !1591
...
while.body:                                       ; preds = %while.cond
  ...
  %call1 = call i8* @gitstrchrnul(i8* noundef %5, i32 noundef 44), !dbg !1599
  ...
  %call2 = call i32 @match_token(i8* noundef %8, i32 noundef %9, i8* noundef getelementptr inbounds ([9 x i8], [9 x i8]* @.str.220, i64 0, i64 0)), !dbg !1608
  %tobool3 = icmp ne i32 %call2, 0, !dbg !1608
  br i1 %tobool3, label %if.then, label %if.else, !dbg !1609

if.then:                                          ; preds = %while.body
  call void @list_builtins(%struct.string_list* noundef %list, i32 noundef 0), !dbg !1610
  br label %if.end36, !dbg !1610

if.else:                                          ; preds = %while.body
  %10 = load i8*, i8** %spec.addr, align 8, !dbg !1611
  %11 = load i32, i32* %len, align 4, !dbg !1613
  %call4 = call i32 @match_token(i8* noundef %10, i32 noundef %11, i8* noundef getelementptr inbounds ([5 x i8], [5 x i8]* @.str.221, i64 0, i64 0)), !dbg !1614
  %tobool5 = icmp ne i32 %call4, 0, !dbg !1614
  br i1 %tobool5, label %if.then6, label %if.else7, !dbg !1615

if.then6:                                         ; preds = %if.else
  call void @list_all_main_cmds(%struct.string_list* noundef %list), !dbg !1616
  br label %if.end35, !dbg !1616

if.else7:                                         ; preds = %if.else
  %12 = load i8*, i8** %spec.addr, align 8, !dbg !1617
  %13 = load i32, i32* %len, align 4, !dbg !1619
  %call8 = call i32 @match_token(i8* noundef %12, i32 noundef %13, i8* noundef getelementptr inbounds ([7 x i8], [7 x i8]* @.str.222, i64 0, i64 0)), !dbg !1620
  %tobool9 = icmp ne i32 %call8, 0, !dbg !1620
  br i1 %tobool9, label %if.then10, label %if.else11, !dbg !1621

if.then10:                                        ; preds = %if.else7
  call void @list_all_other_cmds(%struct.string_list* noundef %list), !dbg !1622
  br label %if.end34, !dbg !1622

if.else11:                                        ; preds = %if.else7
  %14 = load i8*, i8** %spec.addr, align 8, !dbg !1623
  %15 = load i32, i32* %len, align 4, !dbg !1625
  %call12 = call i32 @match_token(i8* noundef %14, i32 noundef %15, i8* noundef getelementptr inbounds ([10 x i8], [10 x i8]* @.str.223, i64 0, i64 0)), !dbg !1626
  %tobool13 = icmp ne i32 %call12, 0, !dbg !1626
  br i1 %tobool13, label %if.then14, label %if.else15, !dbg !1627

if.then14:                                        ; preds = %if.else11
  call void @exclude_helpers_from_list(%struct.string_list* noundef %list), !dbg !1628
  br label %if.end33, !dbg !1628

if.else15:                                        ; preds = %if.else11
  %16 = load i8*, i8** %spec.addr, align 8, !dbg !1629
  %17 = load i32, i32* %len, align 4, !dbg !1631
  %call16 = call i32 @match_token(i8* noundef %16, i32 noundef %17, i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.224, i64 0, i64 0)), !dbg !1632
  %tobool17 = icmp ne i32 %call16, 0, !dbg !1632
  br i1 %tobool17, label %if.then18, label %if.else19, !dbg !1633

if.then18:                                        ; preds = %if.else15
  call void @list_aliases(%struct.string_list* noundef %list), !dbg !1634
  br label %if.end32, !dbg !1634

if.else19:                                        ; preds = %if.else15
  %18 = load i8*, i8** %spec.addr, align 8, !dbg !1635
  %19 = load i32, i32* %len, align 4, !dbg !1637
  %call20 = call i32 @match_token(i8* noundef %18, i32 noundef %19, i8* noundef getelementptr inbounds ([7 x i8], [7 x i8]* @.str.43, i64 0, i64 0)), !dbg !1638
  %tobool21 = icmp ne i32 %call20, 0, !dbg !1638
  br i1 %tobool21, label %if.then22, label %if.else23, !dbg !1639

if.then22:                                        ; preds = %if.else19
  call void @list_cmds_by_config(%struct.string_list* noundef %list), !dbg !1640
...
land.lhs.true:                                    ; preds = %if.else23
  ...
  %call25 = call i32 @strncmp(i8* noundef %21, i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.225, i64 0, i64 0), i64 noundef 5), !dbg !1646
...
if.then27:                                        ; preds = %land.lhs.true
  ...
  call void @strbuf_add(%struct.strbuf* noundef %sb, i8* noundef %add.ptr, i64 noundef %conv28), !dbg !1655
  %buf = getelementptr inbounds %struct.strbuf, %struct.strbuf* %sb, i32 0, i32 2, !dbg !1656
  %25 = load i8*, i8** %buf, align 8, !dbg !1656
  call void @list_cmds_by_category(%struct.string_list* noundef %list, i8* noundef %25), !dbg !1657
  call void @strbuf_release(%struct.strbuf* noundef %sb), !dbg !1658
  br label %if.end, !dbg !1659

if.else29:                                        ; preds = %land.lhs.true, %if.else23
  %call30 = call i8* @_(i8* noundef getelementptr inbounds ([38 x i8], [38 x i8]* @.str.226, i64 0, i64 0)), !dbg !1660
  %26 = load i8*, i8** %spec.addr, align 8, !dbg !1661
  call void (i8*, ...) @die(i8* noundef %call30, i8* noundef %26) #8, !dbg !1662
...
for.body:                                         ; preds = %for.cond
  ...
  %call46 = call i32 @puts(i8* noundef %36), !dbg !1686
...
for.end:                                          ; preds = %for.cond
  call void @string_list_clear(%struct.string_list* noundef %list, i32 noundef 0), !dbg !1691
  ret i32 0, !dbg !1692
}

; Function Attrs: noinline nounwind ssp uwtable
define internal i8* @gitstrchrnul(i8* noundef %s, i32 noundef %c) #0 !dbg !1693 {
entry:
  %s.addr = alloca i8*, align 8
...
; Function Attrs: noinline nounwind ssp uwtable
define internal i32 @match_token(i8* noundef %spec, i32 noundef %len, i8* noundef %token) #0 !dbg !1713 {
entry:
  %spec.addr = alloca i8*, align 8
  ...
  %call = call i64 @strlen(i8* noundef %0), !dbg !1725
...
land.rhs:                                         ; preds = %entry
  ...
  %call3 = call i32 @strncmp(i8* noundef %3, i8* noundef %4, i64 noundef %conv2), !dbg !1733
...
; Function Attrs: noinline nounwind ssp uwtable
define internal void @exclude_helpers_from_list(%struct.string_list* noundef %list) #0 !dbg !1737 {
entry:
...
while.body:                                       ; preds = %while.cond
  ...
  %call = call i8* @strstr(i8* noundef %6, i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.227, i64 0, i64 0)), !dbg !1755
...
if.then:                                          ; preds = %while.body
  ...
  call void @unsorted_string_list_delete_item(%struct.string_list* noundef %7, i32 noundef %8, i32 noundef 0), !dbg !1759
...
; Function Attrs: noinline nounwind ssp uwtable
define internal i32 @run_builtin(%struct.cmd_struct* noundef %p, i32 noundef %argc, i8** noundef %argv) #0 !dbg !1764 {
entry:
  %retval = alloca i32, align 4
...
land.rhs:                                         ; preds = %entry
  ...
  %call = call i32 @strcmp(i8* noundef %4, i8* noundef getelementptr inbounds ([3 x i8], [3 x i8]* @.str.11, i64 0, i64 0)), !dbg !1851
...
if.then10:                                        ; preds = %if.else
  ...
  %call11 = call i8* @setup_git_directory_gently(i32* noundef %nongit_ok), !dbg !1878
...
cond.true:                                        ; preds = %lor.end
  call void @__assert_rtn(i8* noundef getelementptr inbounds ([12 x i8], [12 x i8]* @__func__.run_builtin, i64 0, i64 0), i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 440, i8* noundef getelementptr inbounds ([19 x i8], [19 x i8]* @.str.157, i64 0, i64 0)) #10, !dbg !1883
...
cond.end:                                         ; preds = %cond.false, %14
  ...
  %call20 = call i8* @precompose_argv_prefix(i32 noundef %15, i8** noundef %16, i8* noundef null), !dbg !1886
...
if.then29:                                        ; preds = %land.lhs.true25
  ...
  %call30 = call i32 @check_pager_config(i8* noundef %22), !dbg !1899
...
if.then43:                                        ; preds = %land.lhs.true41
  ...
  call void @trace_repo_setup(i8* noundef %29), !dbg !1919
...
if.then53:                                        ; preds = %if.then49
  %call54 = call i8* @_(i8* noundef getelementptr inbounds ([34 x i8], [34 x i8]* @.str.158, i64 0, i64 0)), !dbg !1932
  ...
  call void (i8*, ...) @die(i8* noundef %call54, i8* noundef %34) #8, !dbg !1935
...
do.body:                                          ; preds = %if.end64
  %call65 = call i32 @trace_pass_fl(%struct.trace_key* noundef @trace_default_key), !dbg !1946
...
if.then67:                                        ; preds = %do.body
  ...
  call void (i8*, i32, i8**, i8*, ...) @trace_argv_printf_fl(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 460, i8** noundef %38, i8* noundef getelementptr inbounds ([21 x i8], [21 x i8]* @.str.159, i64 0, i64 0)), !dbg !1946
...
do.end:                                           ; preds = %if.end68
  ...
  call void @trace2_cmd_name_fl(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 461, i8* noundef %40), !dbg !1950
  call void @trace2_cmd_list_config_fl(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 462), !dbg !1951
  call void @trace2_cmd_list_env_vars_fl(i8* noundef getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 noundef 463), !dbg !1952
  ...
  call void @validate_cache_entries(%struct.index_state* noundef %42), !dbg !1955
  ...
  %call70 = call i32 %44(i32 noundef %45, i8** noundef %46, i8* noundef %47), !dbg !1956
  ...
  call void @validate_cache_entries(%struct.index_state* noundef %49), !dbg !1964
...
if.end74:                                         ; preds = %do.end
  ...
  %call75 = call i32 @fileno(%struct.__sFILE* noundef %52), !dbg !1972
  %call76 = call i32 @"\01_fstat$INODE64"(i32 noundef %call75, %struct.stat* noundef %st), !dbg !1973
...
if.end90:                                         ; preds = %lor.lhs.false
  ...
  %call91 = call i32 @fflush(%struct.__sFILE* noundef %55), !dbg !1984
  %tobool92 = icmp ne i32 %call91, 0, !dbg !1984
  br i1 %tobool92, label %if.then93, label %if.end95, !dbg !1985

if.then93:                                        ; preds = %if.end90
  %call94 = call i8* @_(i8* noundef getelementptr inbounds ([33 x i8], [33 x i8]* @.str.160, i64 0, i64 0)), !dbg !1986
  call void (i8*, ...) @die_errno(i8* noundef %call94) #8, !dbg !1987
  unreachable, !dbg !1987

if.end95:                                         ; preds = %if.end90
  %56 = load %struct.__sFILE*, %struct.__sFILE** @__stdoutp, align 8, !dbg !1988
  %call96 = call i32 @ferror(%struct.__sFILE* noundef %56), !dbg !1990
  %tobool97 = icmp ne i32 %call96, 0, !dbg !1990
  br i1 %tobool97, label %if.then98, label %if.end100, !dbg !1991

if.then98:                                        ; preds = %if.end95
  %call99 = call i8* @_(i8* noundef getelementptr inbounds ([41 x i8], [41 x i8]* @.str.161, i64 0, i64 0)), !dbg !1992
  call void (i8*, ...) @die(i8* noundef %call99) #8, !dbg !1993
  unreachable, !dbg !1993

if.end100:                                        ; preds = %if.end95
  %57 = load %struct.__sFILE*, %struct.__sFILE** @__stdoutp, align 8, !dbg !1994
  %call101 = call i32 @fclose(%struct.__sFILE* noundef %57), !dbg !1996
  %tobool102 = icmp ne i32 %call101, 0, !dbg !1996
  br i1 %tobool102, label %if.then103, label %if.end105, !dbg !1997

if.then103:                                       ; preds = %if.end100
  %call104 = call i8* @_(i8* noundef getelementptr inbounds ([32 x i8], [32 x i8]* @.str.162, i64 0, i64 0)), !dbg !1998
  call void (i8*, ...) @die_errno(i8* noundef %call104) #8, !dbg !1999
...
!52 = !DILocation(line: 125, column: 35, scope: !47)
!53 = !DILocalVariable(name: "def", arg: 2, scope: !47, file: !3, line: 125, type: !19)
!54 = !DILocation(line: 125, column: 44, scope: !47)
!55 = !DILocation(line: 127, column: 6, scope: !56)
!56 = distinct !DILexicalBlock(scope: !47, file: !3, line: 127, column: 6)
...
!60 = !DILocation(line: 127, column: 6, scope: !47)
!61 = !DILocation(line: 128, column: 3, scope: !56)
!62 = !DILocation(line: 129, column: 33, scope: !47)
!63 = !DILocation(line: 129, column: 14, scope: !47)
!64 = !DILocation(line: 129, column: 12, scope: !47)
!65 = !DILocation(line: 130, column: 6, scope: !66)
!66 = distinct !DILexicalBlock(scope: !47, file: !3, line: 130, column: 6)
!67 = !DILocation(line: 130, column: 16, scope: !66)
!68 = !DILocation(line: 130, column: 6, scope: !47)
...
!72 = !DILocation(line: 132, column: 2, scope: !47)
!73 = !DILocation(line: 133, column: 1, scope: !47)
!74 = distinct !DISubprogram(name: "commit_pager_choice", scope: !3, file: !3, line: 111, type: !75, scopeLine: 112, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !50)
...
!86 = distinct !DISubprogram(name: "is_builtin", scope: !3, file: !3, line: 646, type: !87, scopeLine: 647, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !50)
!87 = !DISubroutineType(types: !88)
!88 = !{!19, !26}
!89 = !DILocalVariable(name: "s", arg: 1, scope: !86, file: !3, line: 646, type: !26)
...
!96 = distinct !DISubprogram(name: "get_builtin", scope: !3, file: !3, line: 635, type: !97, scopeLine: 636, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !50)
!97 = !DISubroutineType(types: !98)
!98 = !{!99, !26}
!99 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !23, size: 64)
!100 = !DILocalVariable(name: "s", arg: 1, scope: !96, file: !3, line: 635, type: !26)
!101 = !DILocation(line: 635, column: 51, scope: !96)
!102 = !DILocalVariable(name: "i", scope: !96, file: !3, line: 637, type: !19)
...
!132 = distinct !DISubprogram(name: "load_builtin_commands", scope: !3, file: !3, line: 662, type: !133, scopeLine: 663, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !50)
...
!138 = !{!139, !140, !141}
!139 = !DIDerivedType(tag: DW_TAG_member, name: "alloc", scope: !136, file: !137, line: 8, baseType: !19, size: 32)
!140 = !DIDerivedType(tag: DW_TAG_member, name: "cnt", scope: !136, file: !137, line: 9, baseType: !19, size: 32, offset: 32)
...
!149 = !DIDerivedType(tag: DW_TAG_typedef, name: "__darwin_size_t", file: !150, line: 94, baseType: !9)
...
!152 = !DICompositeType(tag: DW_TAG_array_type, baseType: !6, elements: !153)
!153 = !{!154}
!154 = !DISubrange(count: -1)
!155 = !DILocalVariable(name: "prefix", arg: 1, scope: !132, file: !3, line: 662, type: !26)
...
!159 = !DILocalVariable(name: "name", scope: !132, file: !3, line: 664, type: !26)
!160 = !DILocation(line: 664, column: 14, scope: !132)
!161 = !DILocalVariable(name: "i", scope: !132, file: !3, line: 665, type: !19)
...
!193 = distinct !DISubprogram(name: "skip_prefix", scope: !194, file: !194, line: 674, type: !195, scopeLine: 676, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !50)
!194 = !DIFile(filename: "./git-compat-util.h", directory: "/Users/jryans/Projects/git")
!195 = !DISubroutineType(types: !196)
!196 = !{!19, !26, !26, !31}
!197 = !DILocalVariable(name: "str", arg: 1, scope: !193, file: !194, line: 674, type: !26)
!198 = !DILocation(line: 674, column: 43, scope: !193)
!199 = !DILocalVariable(name: "prefix", arg: 2, scope: !193, file: !194, line: 674, type: !26)
!200 = !DILocation(line: 674, column: 60, scope: !193)
!201 = !DILocalVariable(name: "out", arg: 3, scope: !193, file: !194, line: 675, type: !31)
...
!224 = distinct !DISubprogram(name: "cmd_main", scope: !3, file: !3, line: 864, type: !225, scopeLine: 865, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !50)
!225 = !DISubroutineType(types: !226)
!226 = !{!19, !19, !31}
!227 = !DILocalVariable(name: "argc", arg: 1, scope: !224, file: !3, line: 864, type: !19)
!228 = !DILocation(line: 864, column: 18, scope: !224)
!229 = !DILocalVariable(name: "argv", arg: 2, scope: !224, file: !3, line: 864, type: !31)
!230 = !DILocation(line: 864, column: 37, scope: !224)
!231 = !DILocalVariable(name: "cmd", scope: !224, file: !3, line: 866, type: !26)
!232 = !DILocation(line: 866, column: 14, scope: !224)
!233 = !DILocalVariable(name: "done_help", scope: !224, file: !3, line: 867, type: !19)
...
!242 = !DILocalVariable(name: "slash", scope: !243, file: !3, line: 873, type: !26)
...
!306 = !DILocalVariable(name: "was_alias", scope: !307, file: !3, line: 926, type: !19)
...
!346 = distinct !DISubprogram(name: "git_find_last_dir_sep", scope: !194, file: !194, line: 536, type: !347, scopeLine: 537, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !50)
!347 = !DISubroutineType(types: !348)
!348 = !{!5, !26}
!349 = !DILocalVariable(name: "path", arg: 1, scope: !346, file: !194, line: 536, type: !26)
...
!354 = distinct !DISubprogram(name: "handle_builtin", scope: !3, file: !3, line: 693, type: !355, scopeLine: 694, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !50)
!355 = !DISubroutineType(types: !356)
!356 = !{null, !19, !31}
!357 = !DILocalVariable(name: "argc", arg: 1, scope: !354, file: !3, line: 693, type: !19)
!358 = !DILocation(line: 693, column: 32, scope: !354)
!359 = !DILocalVariable(name: "argv", arg: 2, scope: !354, file: !3, line: 693, type: !31)
...
!364 = !{!365, !366, !367}
!365 = !DIDerivedType(tag: DW_TAG_member, name: "v", scope: !362, file: !363, line: 31, baseType: !31, size: 64)
...
!369 = !DILocalVariable(name: "cmd", scope: !354, file: !3, line: 696, type: !26)
...
!382 = !DILocalVariable(name: "i", scope: !383, file: !3, line: 704, type: !19)
...
!425 = distinct !DISubprogram(name: "_", scope: !426, file: !426, line: 44, type: !427, scopeLine: 45, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !50)
!426 = !DIFile(filename: "./gettext.h", directory: "/Users/jryans/Projects/git")
!427 = !DISubroutineType(types: !428)
!428 = !{!26, !26}
!429 = !DILocalVariable(name: "msgid", arg: 1, scope: !425, file: !426, line: 44, type: !26)
...
!440 = distinct !DISubprogram(name: "handle_options", scope: !3, file: !3, line: 135, type: !441, scopeLine: 136, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !50)
!441 = !DISubroutineType(types: !442)
!442 = !{!19, !443, !444, !444}
!443 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !31, size: 64)
!444 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !19, size: 64)
...
!451 = !DILocalVariable(name: "orig_argv", scope: !440, file: !3, line: 137, type: !31)
...
!459 = !DILocalVariable(name: "cmd", scope: !460, file: !3, line: 140, type: !26)
...
!750 = !DILocalVariable(name: "cwd", scope: !751, file: !3, line: 244, type: !5)
...
!983 = !{!984, !985}
!984 = !DIDerivedType(tag: DW_TAG_member, name: "string", scope: !982, file: !978, line: 69, baseType: !5, size: 64)
...
!989 = !DIDerivedType(tag: DW_TAG_member, name: "strdup_strings", scope: !977, file: !978, line: 91, baseType: !33, size: 1, offset: 192, flags: DIFlagBitField, extraData: i64 192)
...
!996 = !DILocalVariable(name: "i", scope: !976, file: !3, line: 316, type: !19)
...
!1038 = distinct !DISubprogram(name: "run_argv", scope: !3, file: !3, line: 771, type: !1039, scopeLine: 772, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !50)
...
!1045 = !DILocalVariable(name: "done_alias", scope: !1038, file: !3, line: 773, type: !19)
...
!1079 = !DIDerivedType(tag: DW_TAG_typedef, name: "__int32_t", file: !150, line: 46, baseType: !19)
!1080 = !DIDerivedType(tag: DW_TAG_member, name: "trace2_child_id", scope: !1069, file: !1070, line: 79, baseType: !19, size: 32, offset: 416)
...
!1084 = !DIBasicType(name: "unsigned long long", size: 64, encoding: DW_ATE_unsigned)
!1085 = !DIDerivedType(tag: DW_TAG_member, name: "trace2_child_class", scope: !1069, file: !1070, line: 81, baseType: !26, size: 64, offset: 512)
!1086 = !DIDerivedType(tag: DW_TAG_member, name: "trace2_hook_name", scope: !1069, file: !1070, line: 82, baseType: !26, size: 64, offset: 576)
!1087 = !DIDerivedType(tag: DW_TAG_member, name: "in", scope: !1069, file: !1070, line: 102, baseType: !19, size: 32, offset: 640)
!1088 = !DIDerivedType(tag: DW_TAG_member, name: "out", scope: !1069, file: !1070, line: 103, baseType: !19, size: 32, offset: 672)
!1089 = !DIDerivedType(tag: DW_TAG_member, name: "err", scope: !1069, file: !1070, line: 104, baseType: !19, size: 32, offset: 704)
!1090 = !DIDerivedType(tag: DW_TAG_member, name: "dir", scope: !1069, file: !1070, line: 110, baseType: !26, size: 64, offset: 768)
!1091 = !DIDerivedType(tag: DW_TAG_member, name: "no_stdin", scope: !1069, file: !1070, line: 112, baseType: !33, size: 1, offset: 832, flags: DIFlagBitField, extraData: i64 832)
!1092 = !DIDerivedType(tag: DW_TAG_member, name: "no_stdout", scope: !1069, file: !1070, line: 113, baseType: !33, size: 1, offset: 833, flags: DIFlagBitField, extraData: i64 832)
!1093 = !DIDerivedType(tag: DW_TAG_member, name: "no_stderr", scope: !1069, file: !1070, line: 114, baseType: !33, size: 1, offset: 834, flags: DIFlagBitField, extraData: i64 832)
!1094 = !DIDerivedType(tag: DW_TAG_member, name: "git_cmd", scope: !1069, file: !1070, line: 115, baseType: !33, size: 1, offset: 835, flags: DIFlagBitField, extraData: i64 832)
!1095 = !DIDerivedType(tag: DW_TAG_member, name: "silent_exec_failure", scope: !1069, file: !1070, line: 123, baseType: !33, size: 1, offset: 836, flags: DIFlagBitField, extraData: i64 832)
!1096 = !DIDerivedType(tag: DW_TAG_member, name: "use_shell", scope: !1069, file: !1070, line: 131, baseType: !33, size: 1, offset: 837, flags: DIFlagBitField, extraData: i64 832)
!1097 = !DIDerivedType(tag: DW_TAG_member, name: "close_object_store", scope: !1069, file: !1070, line: 139, baseType: !33, size: 1, offset: 838, flags: DIFlagBitField, extraData: i64 832)
!1098 = !DIDerivedType(tag: DW_TAG_member, name: "stdout_to_stderr", scope: !1069, file: !1070, line: 141, baseType: !33, size: 1, offset: 839, flags: DIFlagBitField, extraData: i64 832)
!1099 = !DIDerivedType(tag: DW_TAG_member, name: "clean_on_exit", scope: !1069, file: !1070, line: 142, baseType: !33, size: 1, offset: 840, flags: DIFlagBitField, extraData: i64 832)
!1100 = !DIDerivedType(tag: DW_TAG_member, name: "wait_after_clean", scope: !1069, file: !1070, line: 143, baseType: !33, size: 1, offset: 841, flags: DIFlagBitField, extraData: i64 832)
...
!1107 = !DILocalVariable(name: "i", scope: !1068, file: !3, line: 791, type: !19)
...
!1176 = !DILocalVariable(name: "i", scope: !1177, file: !3, line: 832, type: !19)
...
!1185 = !DIDerivedType(tag: DW_TAG_member, name: "buf", scope: !1180, file: !1181, line: 69, baseType: !5, size: 64, offset: 128)
...
!1243 = distinct !DISubprogram(name: "trace_pass_fl", scope: !1244, file: !1244, line: 273, type: !1245, scopeLine: 274, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !50)
...
!1251 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !26)
!1252 = !DIDerivedType(tag: DW_TAG_member, name: "fd", scope: !1248, file: !1244, line: 85, baseType: !19, size: 32, offset: 64)
!1253 = !DIDerivedType(tag: DW_TAG_member, name: "initialized", scope: !1248, file: !1244, line: 86, baseType: !33, size: 1, offset: 96, flags: DIFlagBitField, extraData: i64 96)
!1254 = !DIDerivedType(tag: DW_TAG_member, name: "need_close", scope: !1248, file: !1244, line: 87, baseType: !33, size: 1, offset: 97, flags: DIFlagBitField, extraData: i64 96)
...
!1264 = distinct !DISubprogram(name: "execv_dashed_external", scope: !3, file: !3, line: 725, type: !1265, scopeLine: 726, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !50)
!1265 = !DISubroutineType(types: !1266)
!1266 = !{null, !31}
!1267 = !DILocalVariable(name: "argv", arg: 1, scope: !1264, file: !3, line: 725, type: !31)
...
!1271 = !DILocalVariable(name: "status", scope: !1264, file: !3, line: 728, type: !19)
...
!1325 = distinct !DISubprogram(name: "strbuf_addstr", scope: !1181, file: !1181, line: 303, type: !1326, scopeLine: 304, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !50)
...
!1331 = !DILocalVariable(name: "s", arg: 2, scope: !1325, file: !1181, line: 303, type: !26)
...
!1339 = distinct !DISubprogram(name: "handle_alias", scope: !3, file: !3, line: 337, type: !1039, scopeLine: 338, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !50)
...
!1344 = !DILocalVariable(name: "envchanged", scope: !1339, file: !3, line: 339, type: !19)
!1345 = !DILocation(line: 339, column: 6, scope: !1339)
!1346 = !DILocalVariable(name: "ret", scope: !1339, file: !3, line: 339, type: !19)
!1347 = !DILocation(line: 339, column: 22, scope: !1339)
!1348 = !DILocalVariable(name: "saved_errno", scope: !1339, file: !3, line: 339, type: !19)
!1349 = !DILocation(line: 339, column: 31, scope: !1339)
!1350 = !DILocation(line: 339, column: 45, scope: !1339)
!1351 = !DILocalVariable(name: "count", scope: !1339, file: !3, line: 340, type: !19)
!1352 = !DILocation(line: 340, column: 6, scope: !1339)
!1353 = !DILocalVariable(name: "option_count", scope: !1339, file: !3, line: 340, type: !19)
!1354 = !DILocation(line: 340, column: 13, scope: !1339)
!1355 = !DILocalVariable(name: "new_argv", scope: !1339, file: !3, line: 341, type: !31)
!1356 = !DILocation(line: 341, column: 15, scope: !1339)
!1357 = !DILocalVariable(name: "alias_command", scope: !1339, file: !3, line: 342, type: !26)
!1358 = !DILocation(line: 342, column: 14, scope: !1339)
!1359 = !DILocalVariable(name: "alias_string", scope: !1339, file: !3, line: 343, type: !5)
...
!1394 = !DILocalVariable(name: "nongit_ok", scope: !1392, file: !3, line: 353, type: !19)
...
!1494 = distinct !DISubprogram(name: "move_array", scope: !194, file: !194, line: 1104, type: !1495, scopeLine: 1105, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !50)
...
!1512 = distinct !DISubprogram(name: "st_mult", scope: !194, file: !194, line: 990, type: !1513, scopeLine: 991, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !50)
...
!1529 = distinct !DISubprogram(name: "copy_array", scope: !194, file: !194, line: 1096, type: !1495, scopeLine: 1097, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !50)
...
!1543 = distinct !DISubprogram(name: "list_builtins", scope: !3, file: !3, line: 651, type: !1544, scopeLine: 652, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !50)
...
!1549 = !DILocalVariable(name: "exclude_option", arg: 2, scope: !1543, file: !3, line: 651, type: !33)
!1550 = !DILocation(line: 651, column: 65, scope: !1543)
!1551 = !DILocalVariable(name: "i", scope: !1543, file: !3, line: 653, type: !19)
...
!1582 = distinct !DISubprogram(name: "list_cmds", scope: !3, file: !3, line: 64, type: !87, scopeLine: 65, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !50)
!1583 = !DILocalVariable(name: "spec", arg: 1, scope: !1582, file: !3, line: 64, type: !26)
...
!1587 = !DILocalVariable(name: "i", scope: !1582, file: !3, line: 67, type: !19)
!1588 = !DILocation(line: 67, column: 6, scope: !1582)
!1589 = !DILocalVariable(name: "nongit", scope: !1582, file: !3, line: 68, type: !19)
...
!1595 = !DILocalVariable(name: "sep", scope: !1596, file: !3, line: 77, type: !26)
...
!1600 = !DILocalVariable(name: "len", scope: !1596, file: !3, line: 78, type: !19)
...
!1693 = distinct !DISubprogram(name: "gitstrchrnul", scope: !194, file: !194, line: 959, type: !1694, scopeLine: 960, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !50)
!1694 = !DISubroutineType(types: !1695)
!1695 = !{!5, !26, !19}
!1696 = !DILocalVariable(name: "s", arg: 1, scope: !1693, file: !194, line: 959, type: !26)
!1697 = !DILocation(line: 959, column: 46, scope: !1693)
!1698 = !DILocalVariable(name: "c", arg: 2, scope: !1693, file: !194, line: 959, type: !19)
...
!1713 = distinct !DISubprogram(name: "match_token", scope: !3, file: !3, line: 57, type: !1714, scopeLine: 58, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !50)
!1714 = !DISubroutineType(types: !1715)
!1715 = !{!19, !26, !19, !26}
!1716 = !DILocalVariable(name: "spec", arg: 1, scope: !1713, file: !3, line: 57, type: !26)
!1717 = !DILocation(line: 57, column: 36, scope: !1713)
!1718 = !DILocalVariable(name: "len", arg: 2, scope: !1713, file: !3, line: 57, type: !19)
!1719 = !DILocation(line: 57, column: 46, scope: !1713)
!1720 = !DILocalVariable(name: "token", arg: 3, scope: !1713, file: !3, line: 57, type: !26)
!1721 = !DILocation(line: 57, column: 63, scope: !1713)
!1722 = !DILocalVariable(name: "token_len", scope: !1713, file: !3, line: 59, type: !19)
...
!1737 = distinct !DISubprogram(name: "exclude_helpers_from_list", scope: !3, file: !3, line: 45, type: !1738, scopeLine: 46, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !50)
...
!1742 = !DILocalVariable(name: "i", scope: !1737, file: !3, line: 47, type: !19)
...
!1764 = distinct !DISubprogram(name: "run_builtin", scope: !3, file: !3, line: 420, type: !1765, scopeLine: 421, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !50)
!1765 = !DISubroutineType(types: !1766)
!1766 = !{!19, !99, !19, !31}
!1767 = !DILocalVariable(name: "p", arg: 1, scope: !1764, file: !3, line: 420, type: !99)
!1768 = !DILocation(line: 420, column: 43, scope: !1764)
!1769 = !DILocalVariable(name: "argc", arg: 2, scope: !1764, file: !3, line: 420, type: !19)
!1770 = !DILocation(line: 420, column: 50, scope: !1764)
!1771 = !DILocalVariable(name: "argv", arg: 3, scope: !1764, file: !3, line: 420, type: !31)
!1772 = !DILocation(line: 420, column: 69, scope: !1764)
!1773 = !DILocalVariable(name: "status", scope: !1764, file: !3, line: 422, type: !19)
!1774 = !DILocation(line: 422, column: 6, scope: !1764)
!1775 = !DILocalVariable(name: "help", scope: !1764, file: !3, line: 422, type: !19)
...
!1801 = !DIDerivedType(tag: DW_TAG_typedef, name: "__uint32_t", file: !150, line: 47, baseType: !33)
...
!1813 = !DIBasicType(name: "long", size: 64, encoding: DW_ATE_signed)
...
!1823 = !DIBasicType(name: "long long", size: 64, encoding: DW_ATE_signed)
...
!1840 = !DILocalVariable(name: "prefix", scope: !1764, file: !3, line: 424, type: !26)
!1841 = !DILocation(line: 424, column: 14, scope: !1764)
!1842 = !DILocalVariable(name: "run_setup", scope: !1764, file: !3, line: 425, type: !19)
...
!1875 = !DILocalVariable(name: "nongit_ok", scope: !1876, file: !3, line: 435, type: !19)
