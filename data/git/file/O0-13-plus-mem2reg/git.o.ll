...
if.end:                                           ; preds = %lor.lhs.false
  %call1 = call i32 @check_pager_config(i8* %cmd), !dbg !61
...
sw.bb:                                            ; preds = %entry
  %call = call i32 @"\01_setenv"(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.15, i64 0, i64 0), i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.16, i64 0, i64 0), i32 1), !dbg !76
...
; Function Attrs: noinline nounwind ssp uwtable
define i32 @is_builtin(i8* %s) #0 !dbg !83 {
entry:
  call void @llvm.dbg.value(metadata i8* %s, metadata !86, metadata !DIExpression()), !dbg !87
  %call = call %struct.cmd_struct* @get_builtin(i8* %s), !dbg !88
...
; Function Attrs: noinline nounwind ssp uwtable
define internal %struct.cmd_struct* @get_builtin(i8* %s) #0 !dbg !92 {
entry:
...
for.body:                                         ; preds = %for.cond
  ...
  %call = call i32 @strcmp(i8* %s, i8* %0), !dbg !112
...
; Function Attrs: noinline nounwind ssp uwtable
define void @load_builtin_commands(i8* %prefix, %struct.cmdnames* %cmds) #0 !dbg !123 {
entry:
  ...
  %call = call i32 @skip_prefix(i8* %0, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i8** %prefix.addr), !dbg !154
  %tobool = icmp ne i32 %call, 0, !dbg !154
  br i1 %tobool, label %if.end, label %if.then, !dbg !155

if.then:                                          ; preds = %entry
  %1 = load i8*, i8** %prefix.addr, align 8, !dbg !156
  call void (i8*, i32, i8*, ...) @BUG_fl(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 674, i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.2, i64 0, i64 0), i8* %1) #8, !dbg !156
  unreachable, !dbg !156
...
for.body:                                         ; preds = %for.cond
  ...
  %call2 = call i32 @skip_prefix(i8* %2, i8* %3, i8** %name), !dbg !169
...
if.then4:                                         ; preds = %for.body
  ...
  %call5 = call i64 @strlen(i8* %5), !dbg !173
  %conv6 = trunc i64 %call5 to i32, !dbg !173
  call void @add_cmdname(%struct.cmdnames* %cmds, i8* %4, i32 %conv6), !dbg !174
...
; Function Attrs: noinline nounwind ssp uwtable
define internal i32 @skip_prefix(i8* %str, i8* %prefix, i8** %out) #0 !dbg !181 {
entry:
...
; Function Attrs: noinline nounwind ssp uwtable
define i32 @cmd_main(i32 %argc, i8** %argv) #0 !dbg !207 {
entry:
...
if.else:                                          ; preds = %entry
  ...
  %call = call i8* @git_find_last_dir_sep(i8* %3), !dbg !227
...
if.end3:                                          ; preds = %if.end, %if.then
  ...
  call void @trace_command_performance(i8** %4), !dbg !237
  %5 = load i8*, i8** %cmd, align 8, !dbg !238
  %call4 = call i32 @skip_prefix(i8* %5, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str, i64 0, i64 0), i8** %cmd), !dbg !240
...
if.then6:                                         ; preds = %if.end3
  ...
  call void @handle_builtin(i32 %8, i8** %9), !dbg !248
  %call8 = call i8* @_(i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.4, i64 0, i64 0)), !dbg !249
  %10 = load i8*, i8** %cmd, align 8, !dbg !250
  call void (i8*, ...) @die(i8* %call8, i8* %10) #8, !dbg !251
  unreachable, !dbg !251
...
if.end9:                                          ; preds = %if.end3
  ...
  %call10 = call i32 @handle_options(i8*** %argv.addr, i32* %argc.addr, i32* null), !dbg !254
...
if.then12:                                        ; preds = %if.end9
  ...
  %call13 = call i8* @_(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.5, i64 0, i64 0)), !dbg !260
  %call14 = call i32 (i8*, ...) @printf(i8* %call13, i8* getelementptr inbounds ([389 x i8], [389 x i8]* @git_usage_string, i64 0, i64 0)), !dbg !261
  call void @list_common_cmds_help(), !dbg !262
  %call15 = call i8* @_(i8* getelementptr inbounds ([231 x i8], [231 x i8]* @git_more_info_string, i64 0, i64 0)), !dbg !263
  %call16 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.6, i64 0, i64 0), i8* %call15), !dbg !264
  %call17 = call i32 @common_exit(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 907, i32 1), !dbg !265
  call void @exit(i32 %call17) #8, !dbg !265
  unreachable, !dbg !265
...
if.end18:                                         ; preds = %if.end9
  ...
  %call20 = call i32 @strcmp(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.7, i64 0, i64 0), i8* %15), !dbg !268
...
lor.lhs.false:                                    ; preds = %if.end18
  ...
  %call23 = call i32 @strcmp(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.8, i64 0, i64 0), i8* %17), !dbg !271
...
if.else27:                                        ; preds = %lor.lhs.false
  ...
  %call29 = call i32 @strcmp(i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.10, i64 0, i64 0), i8* %20), !dbg !277
...
lor.lhs.false31:                                  ; preds = %if.else27
  ...
  %call33 = call i32 @strcmp(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.11, i64 0, i64 0), i8* %22), !dbg !280
...
while.body:                                       ; preds = %if.end38, %if.end56
  ...
  %call40 = call i32 @run_argv(i32* %argc.addr, i8*** %argv.addr), !dbg !288
...
if.then45:                                        ; preds = %if.end43
  ...
  %call46 = call i8* @_(i8* getelementptr inbounds ([59 x i8], [59 x i8]* @.str.13, i64 0, i64 0)), !dbg !302
  ...
  %call48 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %27, i8* %call46, i8* %28, i8* %30), !dbg !305
  %call49 = call i32 @common_exit(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 933, i32 1), !dbg !306
  call void @exit(i32 %call49) #8, !dbg !306
  unreachable, !dbg !306
...
if.then52:                                        ; preds = %if.end50
  ...
  %call53 = call i8* @help_unknown_cmd(i8* %31), !dbg !312
...
while.end:                                        ; preds = %if.else55, %if.then42
  ...
  %call57 = call i8* @_(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.14, i64 0, i64 0)), !dbg !321
  %34 = load i8*, i8** %cmd, align 8, !dbg !322
  %call58 = call i32* @__error(), !dbg !323
  %35 = load i32, i32* %call58, align 4, !dbg !323
  %call59 = call i8* @"\01_strerror"(i32 %35), !dbg !324
  %call60 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %33, i8* %call57, i8* %34, i8* %call59), !dbg !325
  ret i32 1, !dbg !326
}

; Function Attrs: noinline nounwind ssp uwtable
define internal i8* @git_find_last_dir_sep(i8* %path) #0 !dbg !327 {
entry:
  call void @llvm.dbg.value(metadata i8* %path, metadata !330, metadata !DIExpression()), !dbg !331
  %call = call i8* @strrchr(i8* %path, i32 47), !dbg !332
  ret i8* %call, !dbg !333
}
...
; Function Attrs: noinline nounwind ssp uwtable
define internal void @handle_builtin(i32 %argc, i8** %argv) #0 !dbg !334 {
entry:
...
land.lhs.true:                                    ; preds = %entry
  ...
  %call = call i32 @strcmp(i8* %2, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.10, i64 0, i64 0)), !dbg !354
...
for.body:                                         ; preds = %for.cond
  ...
  %call7 = call i8* @strvec_push(%struct.strvec* %args, i8* %4), !dbg !372
  %tobool8 = icmp ne i32 %i.0, 0, !dbg !373
  br i1 %tobool8, label %if.end, label %if.then9, !dbg !375

if.then9:                                         ; preds = %for.body
  %call10 = call i8* @strvec_push(%struct.strvec* %args, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.156, i64 0, i64 0)), !dbg !376
...
if.end12:                                         ; preds = %for.end, %land.lhs.true, %entry
  ...
  %call13 = call %struct.cmd_struct* @get_builtin(i8* %cmd.0), !dbg !385
...
if.then15:                                        ; preds = %if.end12
  %call16 = call i32 @run_builtin(%struct.cmd_struct* %call13, i32 %argc.addr.0, i8** %argv.addr.0), !dbg !390
  %call17 = call i32 @common_exit(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 721, i32 %call16), !dbg !390
  call void @exit(i32 %call17) #8, !dbg !390
  unreachable, !dbg !390

if.end18:                                         ; preds = %if.end12
  call void @strvec_clear(%struct.strvec* %args), !dbg !391
  ret void, !dbg !392
}

; Function Attrs: noinline nounwind ssp uwtable
define internal i8* @_(i8* %msgid) #0 !dbg !393 {
entry:
...
if.end:                                           ; preds = %entry
  %call = call i8* @libintl_gettext(i8* %msgid), !dbg !403
...
; Function Attrs: noinline nounwind ssp uwtable
define internal i32 @handle_options(i8*** %argv, i32* %argc, i32* %envchanged) #0 !dbg !406 {
entry:
  %cmd = alloca i8*, align 8
...
if.end:                                           ; preds = %while.body
  ...
  %call = call i32 @strcmp(i8* %6, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.10, i64 0, i64 0)), !dbg !432
...
lor.lhs.false:                                    ; preds = %if.end
  ...
  %call4 = call i32 @strcmp(i8* %7, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.11, i64 0, i64 0)), !dbg !435
...
lor.lhs.false6:                                   ; preds = %lor.lhs.false
  ...
  %call7 = call i32 @strcmp(i8* %8, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.7, i64 0, i64 0)), !dbg !438
...
lor.lhs.false9:                                   ; preds = %lor.lhs.false6
  ...
  %call10 = call i32 @strcmp(i8* %9, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.8, i64 0, i64 0)), !dbg !441
...
if.end13:                                         ; preds = %lor.lhs.false9
  ...
  %call14 = call i32 @skip_prefix(i8* %10, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.164, i64 0, i64 0), i8** %cmd), !dbg !446
...
if.then20:                                        ; preds = %if.then16
  ...
  call void @git_set_exec_path(i8* %add.ptr), !dbg !456
  br label %if.end24, !dbg !456

if.else:                                          ; preds = %if.then16
  %call21 = call i8* @git_exec_path(), !dbg !457
  %call22 = call i32 @puts(i8* %call21), !dbg !459
  call void @trace2_cmd_name_fl(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 161, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.165, i64 0, i64 0)), !dbg !460
  %call23 = call i32 @common_exit(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 162, i32 0), !dbg !461
  call void @exit(i32 %call23) #8, !dbg !461
  unreachable, !dbg !461
...
if.else25:                                        ; preds = %if.end13
  ...
  %call26 = call i32 @strcmp(i8* %14, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.166, i64 0, i64 0)), !dbg !465
  %tobool27 = icmp ne i32 %call26, 0, !dbg !465
  br i1 %tobool27, label %if.else32, label %if.then28, !dbg !466

if.then28:                                        ; preds = %if.else25
  %call29 = call i8* @system_path(i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.167, i64 0, i64 0)), !dbg !467
  %call30 = call i32 @puts(i8* %call29), !dbg !469
  call void @trace2_cmd_name_fl(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 166, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.165, i64 0, i64 0)), !dbg !470
  %call31 = call i32 @common_exit(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 167, i32 0), !dbg !471
  call void @exit(i32 %call31) #8, !dbg !471
  unreachable, !dbg !471

if.else32:                                        ; preds = %if.else25
  %15 = load i8*, i8** %cmd, align 8, !dbg !472
  %call33 = call i32 @strcmp(i8* %15, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.168, i64 0, i64 0)), !dbg !474
  %tobool34 = icmp ne i32 %call33, 0, !dbg !474
  br i1 %tobool34, label %if.else39, label %if.then35, !dbg !475

if.then35:                                        ; preds = %if.else32
  %call36 = call i8* @system_path(i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.169, i64 0, i64 0)), !dbg !476
  %call37 = call i32 @puts(i8* %call36), !dbg !478
  call void @trace2_cmd_name_fl(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 170, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.165, i64 0, i64 0)), !dbg !479
  %call38 = call i32 @common_exit(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 171, i32 0), !dbg !480
  call void @exit(i32 %call38) #8, !dbg !480
  unreachable, !dbg !480

if.else39:                                        ; preds = %if.else32
  %16 = load i8*, i8** %cmd, align 8, !dbg !481
  %call40 = call i32 @strcmp(i8* %16, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.170, i64 0, i64 0)), !dbg !483
  %tobool41 = icmp ne i32 %call40, 0, !dbg !483
  br i1 %tobool41, label %if.else46, label %if.then42, !dbg !484

if.then42:                                        ; preds = %if.else39
  %call43 = call i8* @system_path(i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.171, i64 0, i64 0)), !dbg !485
  %call44 = call i32 @puts(i8* %call43), !dbg !487
  call void @trace2_cmd_name_fl(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 174, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.165, i64 0, i64 0)), !dbg !488
  %call45 = call i32 @common_exit(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 175, i32 0), !dbg !489
  call void @exit(i32 %call45) #8, !dbg !489
  unreachable, !dbg !489

if.else46:                                        ; preds = %if.else39
  %17 = load i8*, i8** %cmd, align 8, !dbg !490
  %call47 = call i32 @strcmp(i8* %17, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.172, i64 0, i64 0)), !dbg !492
...
lor.lhs.false49:                                  ; preds = %if.else46
  ...
  %call50 = call i32 @strcmp(i8* %18, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.173, i64 0, i64 0)), !dbg !495
...
if.else53:                                        ; preds = %lor.lhs.false49
  ...
  %call54 = call i32 @strcmp(i8* %19, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.174, i64 0, i64 0)), !dbg !502
...
lor.lhs.false56:                                  ; preds = %if.else53
  ...
  %call57 = call i32 @strcmp(i8* %20, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.175, i64 0, i64 0)), !dbg !505
...
if.else63:                                        ; preds = %lor.lhs.false56
  ...
  %call64 = call i32 @strcmp(i8* %21, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.176, i64 0, i64 0)), !dbg !517
...
if.then66:                                        ; preds = %if.else63
  ...
  %call67 = call i32 @"\01_setenv"(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.177, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.178, i64 0, i64 0), i32 1), !dbg !521
...
if.else71:                                        ; preds = %if.else63
  ...
  %call72 = call i32 @strcmp(i8* %22, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.179, i64 0, i64 0)), !dbg !530
...
if.then77:                                        ; preds = %if.then74
  ...
  %call78 = call i8* @_(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.180, i64 0, i64 0)), !dbg !539
  %call79 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %24, i8* %call78, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.179, i64 0, i64 0)), !dbg !540
  call void @usage(i8* getelementptr inbounds ([389 x i8], [389 x i8]* @git_usage_string, i64 0, i64 0)) #8, !dbg !541
  unreachable, !dbg !541
...
if.end80:                                         ; preds = %if.then74
  ...
  %call82 = call i32 @"\01_setenv"(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.181, i64 0, i64 0), i8* %26, i32 1), !dbg !544
...
if.else86:                                        ; preds = %if.else71
  ...
  %call87 = call i32 @skip_prefix(i8* %29, i8* getelementptr inbounds ([11 x i8], [11 x i8]* @.str.182, i64 0, i64 0), i8** %cmd), !dbg !555
...
if.then89:                                        ; preds = %if.else86
  ...
  %call90 = call i32 @"\01_setenv"(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.181, i64 0, i64 0), i8* %30, i32 1), !dbg !559
...
if.else94:                                        ; preds = %if.else86
  ...
  %call95 = call i32 @strcmp(i8* %31, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.183, i64 0, i64 0)), !dbg !568
...
if.then100:                                       ; preds = %if.then97
  ...
  %call101 = call i8* @_(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.184, i64 0, i64 0)), !dbg !577
  %call102 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %33, i8* %call101), !dbg !578
  call void @usage(i8* getelementptr inbounds ([389 x i8], [389 x i8]* @git_usage_string, i64 0, i64 0)) #8, !dbg !579
  unreachable, !dbg !579
...
if.end103:                                        ; preds = %if.then97
  ...
  %call105 = call i32 @"\01_setenv"(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.185, i64 0, i64 0), i8* %35, i32 1), !dbg !582
...
if.else111:                                       ; preds = %if.else94
  ...
  %call112 = call i32 @skip_prefix(i8* %38, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.186, i64 0, i64 0), i8** %cmd), !dbg !593
...
if.then114:                                       ; preds = %if.else111
  ...
  %call115 = call i32 @"\01_setenv"(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.185, i64 0, i64 0), i8* %39, i32 1), !dbg !597
...
if.else119:                                       ; preds = %if.else111
  ...
  %call120 = call i32 @strcmp(i8* %40, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.187, i64 0, i64 0)), !dbg !606
...
if.then125:                                       ; preds = %if.then122
  ...
  %call126 = call i8* @_(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.180, i64 0, i64 0)), !dbg !615
  %call127 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %42, i8* %call126, i8* getelementptr inbounds ([12 x i8], [12 x i8]* @.str.187, i64 0, i64 0)), !dbg !616
  call void @usage(i8* getelementptr inbounds ([389 x i8], [389 x i8]* @git_usage_string, i64 0, i64 0)) #8, !dbg !617
  unreachable, !dbg !617
...
if.end128:                                        ; preds = %if.then122
  ...
  %call130 = call i32 @"\01_setenv"(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.188, i64 0, i64 0), i8* %44, i32 1), !dbg !620
...
if.else136:                                       ; preds = %if.else119
  ...
  %call137 = call i32 @skip_prefix(i8* %47, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.189, i64 0, i64 0), i8** %cmd), !dbg !631
...
if.then139:                                       ; preds = %if.else136
  ...
  %call140 = call i32 @"\01_setenv"(i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.188, i64 0, i64 0), i8* %48, i32 1), !dbg !635
...
if.else144:                                       ; preds = %if.else136
  ...
  %call145 = call i32 @strcmp(i8* %49, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.190, i64 0, i64 0)), !dbg !644
...
if.then150:                                       ; preds = %if.then147
  ...
  %call151 = call i8* @_(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.191, i64 0, i64 0)), !dbg !653
  %call152 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %51, i8* %call151), !dbg !654
  call void @usage(i8* getelementptr inbounds ([389 x i8], [389 x i8]* @git_usage_string, i64 0, i64 0)) #8, !dbg !655
  unreachable, !dbg !655
...
if.end153:                                        ; preds = %if.then147
  ...
  %call155 = call i32 @"\01_setenv"(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.192, i64 0, i64 0), i8* %53, i32 1), !dbg !658
...
if.else161:                                       ; preds = %if.else144
  ...
  %call162 = call i32 @skip_prefix(i8* %56, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.193, i64 0, i64 0), i8** %cmd), !dbg !669
...
if.then164:                                       ; preds = %if.else161
  ...
  %call165 = call i32 @"\01_setenv"(i8* getelementptr inbounds ([26 x i8], [26 x i8]* @.str.192, i64 0, i64 0), i8* %57, i32 1), !dbg !673
...
if.else169:                                       ; preds = %if.else161
  ...
  %call170 = call i32 @strcmp(i8* %58, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.194, i64 0, i64 0)), !dbg !682
...
if.then172:                                       ; preds = %if.else169
  ...
  %call174 = call i32 @"\01_setenv"(i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.181, i64 0, i64 0), i8* %call173, i32 0), !dbg !689
  call void @free(i8* %call173), !dbg !690
  %call175 = call i32 @"\01_setenv"(i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.195, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.196, i64 0, i64 0), i32 1), !dbg !691
...
if.else179:                                       ; preds = %if.else169
  ...
  %call180 = call i32 @strcmp(i8* %59, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.197, i64 0, i64 0)), !dbg !700
...
if.then185:                                       ; preds = %if.then182
  ...
  %call186 = call i8* @_(i8* getelementptr inbounds ([35 x i8], [35 x i8]* @.str.198, i64 0, i64 0)), !dbg !709
  %call187 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %61, i8* %call186), !dbg !710
  call void @usage(i8* getelementptr inbounds ([389 x i8], [389 x i8]* @git_usage_string, i64 0, i64 0)) #8, !dbg !711
  unreachable, !dbg !711
...
if.end188:                                        ; preds = %if.then182
  ...
  call void @git_config_push_parameter(i8* %63), !dbg !714
...
if.else192:                                       ; preds = %if.else179
  ...
  %call193 = call i32 @strcmp(i8* %66, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.199, i64 0, i64 0)), !dbg !720
...
if.then198:                                       ; preds = %if.then195
  ...
  %call199 = call i8* @_(i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.200, i64 0, i64 0)), !dbg !729
  %call200 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %68, i8* %call199), !dbg !730
  call void @usage(i8* getelementptr inbounds ([389 x i8], [389 x i8]* @git_usage_string, i64 0, i64 0)) #8, !dbg !731
  unreachable, !dbg !731
...
if.end201:                                        ; preds = %if.then195
  ...
  call void @git_config_push_env(i8* %70), !dbg !734
...
if.else205:                                       ; preds = %if.else192
  ...
  %call206 = call i32 @skip_prefix(i8* %73, i8* getelementptr inbounds ([14 x i8], [14 x i8]* @.str.201, i64 0, i64 0), i8** %cmd), !dbg !740
...
if.then208:                                       ; preds = %if.else205
  ...
  call void @git_config_push_env(i8* %74), !dbg !744
  br label %if.end320, !dbg !745

if.else209:                                       ; preds = %if.else205
  %75 = load i8*, i8** %cmd, align 8, !dbg !746
  %call210 = call i32 @strcmp(i8* %75, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.202, i64 0, i64 0)), !dbg !748
...
if.then212:                                       ; preds = %if.else209
  %call213 = call i32 @"\01_setenv"(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.203, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.178, i64 0, i64 0), i32 1), !dbg !750
...
if.else217:                                       ; preds = %if.else209
  ...
  %call218 = call i32 @strcmp(i8* %76, i8* getelementptr inbounds ([23 x i8], [23 x i8]* @.str.204, i64 0, i64 0)), !dbg !760
...
if.then220:                                       ; preds = %if.else217
  %call221 = call i32 @"\01_setenv"(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.203, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.196, i64 0, i64 0), i32 1), !dbg !762
...
if.else225:                                       ; preds = %if.else217
  ...
  %call226 = call i32 @strcmp(i8* %77, i8* getelementptr inbounds ([17 x i8], [17 x i8]* @.str.205, i64 0, i64 0)), !dbg !772
...
if.then228:                                       ; preds = %if.else225
  %call229 = call i32 @"\01_setenv"(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.206, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.178, i64 0, i64 0), i32 1), !dbg !774
...
if.else233:                                       ; preds = %if.else225
  ...
  %call234 = call i32 @strcmp(i8* %78, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.207, i64 0, i64 0)), !dbg !784
...
if.then236:                                       ; preds = %if.else233
  %call237 = call i32 @"\01_setenv"(i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.208, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.178, i64 0, i64 0), i32 1), !dbg !786
...
if.else241:                                       ; preds = %if.else233
  ...
  %call242 = call i32 @strcmp(i8* %79, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.209, i64 0, i64 0)), !dbg !796
...
if.then244:                                       ; preds = %if.else241
  %call245 = call i32 @"\01_setenv"(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.210, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.178, i64 0, i64 0), i32 1), !dbg !798
...
if.else249:                                       ; preds = %if.else241
  ...
  %call250 = call i32 @strcmp(i8* %80, i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.211, i64 0, i64 0)), !dbg !808
...
if.then252:                                       ; preds = %if.else249
  %call253 = call i32 @"\01_setenv"(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.212, i64 0, i64 0), i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.196, i64 0, i64 0), i32 1), !dbg !810
...
if.else257:                                       ; preds = %if.else249
  ...
  %call258 = call i32 @strcmp(i8* %81, i8* getelementptr inbounds ([15 x i8], [15 x i8]* @.str.213, i64 0, i64 0)), !dbg !820
...
if.then260:                                       ; preds = %if.else257
  ...
  call void @set_alternate_shallow_file(%struct.repository* %84, i8* %86, i32 1), !dbg !828
...
if.else267:                                       ; preds = %if.else257
  ...
  %call268 = call i32 @strcmp(i8* %87, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.214, i64 0, i64 0)), !dbg !837
...
if.then273:                                       ; preds = %if.then270
  ...
  %call274 = call i8* @_(i8* getelementptr inbounds ([36 x i8], [36 x i8]* @.str.180, i64 0, i64 0)), !dbg !846
  %call275 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %89, i8* %call274, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.214, i64 0, i64 0)), !dbg !847
  call void @usage(i8* getelementptr inbounds ([389 x i8], [389 x i8]* @git_usage_string, i64 0, i64 0)) #8, !dbg !848
  unreachable, !dbg !848
...
if.then280:                                       ; preds = %if.end276
  ...
  %call282 = call i32 @chdir(i8* %94), !dbg !857
...
if.then284:                                       ; preds = %if.then280
  ...
  call void (i8*, ...) @die_errno(i8* getelementptr inbounds ([22 x i8], [22 x i8]* @.str.215, i64 0, i64 0), i8* %96) #8, !dbg !861
  unreachable, !dbg !861
...
if.else293:                                       ; preds = %if.else267
  ...
  %call294 = call i32 @skip_prefix(i8* %99, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.216, i64 0, i64 0), i8** %cmd), !dbg !873
...
if.then296:                                       ; preds = %if.else293
  call void @trace2_cmd_name_fl(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 313, i8* getelementptr inbounds ([8 x i8], [8 x i8]* @.str.165, i64 0, i64 0)), !dbg !875
  %100 = load i8*, i8** %cmd, align 8, !dbg !877
  %call297 = call i32 @strcmp(i8* %100, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.217, i64 0, i64 0)), !dbg !879
...
if.then299:                                       ; preds = %if.then296
  ...
  call void @list_builtins(%struct.string_list* %list, i32 64), !dbg !902
...
for.body:                                         ; preds = %for.cond
  ...
  %call304 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.218, i64 0, i64 0), i8* %106), !dbg !916
...
for.end:                                          ; preds = %for.cond
  call void @string_list_clear(%struct.string_list* %list, i32 0), !dbg !921
  %call305 = call i32 @common_exit(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 322, i32 0), !dbg !922
  call void @exit(i32 %call305) #8, !dbg !922
  unreachable, !dbg !922

if.else306:                                       ; preds = %if.then296
  %107 = load i8*, i8** %cmd, align 8, !dbg !923
  %call307 = call i32 @list_cmds(i8* %107), !dbg !923
  %call308 = call i32 @common_exit(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 324, i32 %call307), !dbg !923
  call void @exit(i32 %call308) #8, !dbg !923
  unreachable, !dbg !923

if.else309:                                       ; preds = %if.else293
  %108 = load %struct.__sFILE*, %struct.__sFILE** @__stderrp, align 8, !dbg !925
  %call310 = call i8* @_(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.219, i64 0, i64 0)), !dbg !927
  %109 = load i8*, i8** %cmd, align 8, !dbg !928
  %call311 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf(%struct.__sFILE* %108, i8* %call310, i8* %109), !dbg !929
  call void @usage(i8* getelementptr inbounds ([389 x i8], [389 x i8]* @git_usage_string, i64 0, i64 0)) #8, !dbg !930
  unreachable, !dbg !930
...
; Function Attrs: noinline nounwind ssp uwtable
define internal i32 @run_argv(i32* %argcp, i8*** %argv) #0 !dbg !939 {
entry:
...
if.then:                                          ; preds = %while.body
  ...
  call void @handle_builtin(i32 %1, i8** %2), !dbg !955
  br label %if.end28, !dbg !955

if.else:                                          ; preds = %while.body
  %3 = load i8**, i8*** %argv, align 8, !dbg !956
  %4 = load i8*, i8** %3, align 8, !dbg !958
  %call = call %struct.cmd_struct* @get_builtin(i8* %4), !dbg !959
...
if.then2:                                         ; preds = %if.else
  ...
  call void @trace2_cmd_name_fl(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 800, i8* getelementptr inbounds ([16 x i8], [16 x i8]* @.str.228, i64 0, i64 0)), !dbg !1001
...
if.then5:                                         ; preds = %if.then2
  ...
  call void (i8*, ...) @die(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.158, i64 0, i64 0), i8* %12) #8, !dbg !1007
...
if.end:                                           ; preds = %if.then2
  ...
  %call6 = call i8* @strvec_push(%struct.strvec* %args, i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.229, i64 0, i64 0)), !dbg !1010
...
for.body:                                         ; preds = %for.cond
  ...
  %call8 = call i8* @strvec_push(%struct.strvec* %args7, i8* %15), !dbg !1023
...
do.body:                                          ; preds = %for.end
  %call9 = call i32 @trace_pass_fl(%struct.trace_key* @trace_default_key), !dbg !1029
...
if.then11:                                        ; preds = %do.body
  ...
  call void (i8*, i32, i8**, i8*, ...) @trace_argv_printf_fl(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 811, i8** %16, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.230, i64 0, i64 0)), !dbg !1029
...
do.end:                                           ; preds = %if.end13
  ...
  %call20 = call i32 @run_command(%struct.child_process* %cmd), !dbg !1041
...
if.then24:                                        ; preds = %lor.lhs.false, %do.end
  %call25 = call i32 @common_exit(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 823, i32 %call20), !dbg !1048
  call void @exit(i32 %call25) #8, !dbg !1048
  unreachable, !dbg !1048

if.end26:                                         ; preds = %lor.lhs.false
  %18 = load i8**, i8*** %argv, align 8, !dbg !1049
  %19 = load i8*, i8** %18, align 8, !dbg !1050
  call void (i8*, ...) @die(i8* getelementptr inbounds ([29 x i8], [29 x i8]* @.str.232, i64 0, i64 0), i8* %19) #8, !dbg !1051
...
if.end28:                                         ; preds = %if.end27, %if.then
  ...
  call void @execv_dashed_external(i8** %20), !dbg !1053
  ...
  %call30 = call %struct.string_list_item* @unsorted_string_list_lookup(%struct.string_list* %cmd_list, i8* %22), !dbg !1056
...
for.body37:                                       ; preds = %for.cond34
  ...
  call void (%struct.strbuf*, i8*, ...) @strbuf_addf(%struct.strbuf* %sb, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.233, i64 0, i64 0), i8* %26), !dbg !1086
...
if.then42:                                        ; preds = %for.body37
  call void @strbuf_addstr(%struct.strbuf* %sb, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.234, i64 0, i64 0)), !dbg !1090
...
if.then48:                                        ; preds = %if.else43
  call void @strbuf_addstr(%struct.strbuf* %sb, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.235, i64 0, i64 0)), !dbg !1097
...
for.end53:                                        ; preds = %for.cond34
  %call54 = call i8* @_(i8* getelementptr inbounds ([61 x i8], [61 x i8]* @.str.236, i64 0, i64 0)), !dbg !1103
  ...
  call void (i8*, ...) @die(i8* %call54, i8* %29, i8* %30) #8, !dbg !1108
...
if.end58:                                         ; preds = %if.end28
  ...
  %call60 = call %struct.string_list_item* @string_list_append(%struct.string_list* %cmd_list, i8* %32), !dbg !1111
  %call61 = call i32 @handle_alias(i32* %argcp, i8*** %argv), !dbg !1112
...
while.end:                                        ; preds = %if.then63
  call void @string_list_clear(%struct.string_list* %cmd_list, i32 0), !dbg !1118
...
; Function Attrs: noinline nounwind ssp uwtable
define internal i32 @trace_pass_fl(%struct.trace_key* %key) #0 !dbg !1120 {
entry:
...
; Function Attrs: noinline nounwind ssp uwtable
define internal void @execv_dashed_external(i8** %argv) #0 !dbg !1140 {
entry:
  %cmd = alloca %struct.child_process, align 8
...
if.then:                                          ; preds = %entry
  %call1 = call i8* @_(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.158, i64 0, i64 0)), !dbg !1150
  %arrayidx = getelementptr inbounds i8*, i8** %argv, i64 0, !dbg !1151
  %6 = load i8*, i8** %arrayidx, align 8, !dbg !1151
  call void (i8*, ...) @die(i8* %call1, i8* %6) #8, !dbg !1152
...
land.lhs.true:                                    ; preds = %if.end
  ...
  %call3 = call i32 @is_builtin(i8* %8), !dbg !1158
...
if.then5:                                         ; preds = %land.lhs.true
  ...
  %call7 = call i32 @check_pager_config(i8* %9), !dbg !1161
...
if.end8:                                          ; preds = %if.then5, %land.lhs.true, %if.end
  ...
  %call10 = call i8* (%struct.strvec*, i8*, ...) @strvec_pushf(%struct.strvec* %args, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.237, i64 0, i64 0), i8* %10), !dbg !1167
  ...
  call void @strvec_pushv(%struct.strvec* %args11, i8** %add.ptr), !dbg !1170
  ...
  call void @trace2_cmd_name_fl(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 744, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.239, i64 0, i64 0)), !dbg !1179
  br label %do.body, !dbg !1180

do.body:                                          ; preds = %if.end8
  %call18 = call i32 @trace_pass_fl(%struct.trace_key* @trace_default_key), !dbg !1181
...
if.then20:                                        ; preds = %do.body
  ...
  call void (i8*, i32, i8**, i8*, ...) @trace_argv_printf_fl(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 750, i8** %11, i8* getelementptr inbounds ([13 x i8], [13 x i8]* @.str.230, i64 0, i64 0)), !dbg !1181
...
do.end:                                           ; preds = %if.end22
  %call23 = call i32 @run_command(%struct.child_process* %cmd), !dbg !1185
...
if.then25:                                        ; preds = %do.end
  %call26 = call i32 @common_exit(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 766, i32 %call23), !dbg !1190
  call void @exit(i32 %call26) #8, !dbg !1190
...
if.then29:                                        ; preds = %if.else
  %call30 = call i32 @common_exit(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 768, i32 128), !dbg !1195
  call void @exit(i32 %call30) #8, !dbg !1195
...
; Function Attrs: noinline nounwind ssp uwtable
define internal void @strbuf_addstr(%struct.strbuf* %sb, i8* %s) #0 !dbg !1197 {
entry:
  ...
  %call = call i64 @strlen(i8* %s), !dbg !1204
  call void @strbuf_add(%struct.strbuf* %sb, i8* %s, i64 %call), !dbg !1205
  ret void, !dbg !1206
}
...
; Function Attrs: noinline nounwind ssp uwtable
define internal i32 @handle_alias(i32* %argcp, i8*** %argv) #0 !dbg !1207 {
entry:
  ...
  %call1 = call i8* @alias_lookup(i8* %2), !dbg !1223
...
land.lhs.true:                                    ; preds = %if.then
  ...
  %call3 = call i32 @strcmp(i8* %5, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.11, i64 0, i64 0)), !dbg !1235
...
if.then5:                                         ; preds = %land.lhs.true
  ...
  %call6 = call i8* @_(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.240, i64 0, i64 0)), !dbg !1238
  %call7 = call i32 (%struct.__sFILE*, i8*, ...) @fprintf_ln(%struct.__sFILE* %6, i8* %call6, i8* %2, i8* %call1), !dbg !1239
...
if.then11:                                        ; preds = %if.end
  ...
  %call12 = call i8* @setup_git_directory_gently(i32* %nongit_ok), !dbg !1249
  ...
  %call19 = call i8* @strvec_push(%struct.strvec* %args, i8* %add.ptr), !dbg !1261
  ...
  call void @strvec_pushv(%struct.strvec* %args20, i8** %add.ptr21), !dbg !1265
  ...
  call void @trace2_cmd_alias_fl(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 367, i8* %2, i8** %15), !dbg !1266
  call void @trace2_cmd_list_config_fl(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 368), !dbg !1267
  call void @trace2_cmd_list_env_vars_fl(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 369), !dbg !1268
  call void @trace2_cmd_name_fl(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 370, i8* getelementptr inbounds ([18 x i8], [18 x i8]* @.str.242, i64 0, i64 0)), !dbg !1269
  %call23 = call i32 @run_command(%struct.child_process* %child), !dbg !1270
...
if.then26:                                        ; preds = %if.then11
  %call27 = call i32 @common_exit(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 374, i32 %call23), !dbg !1274
  call void @exit(i32 %call27) #8, !dbg !1274
  unreachable, !dbg !1274

if.end28:                                         ; preds = %if.then11
  %call29 = call i8* @_(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.243, i64 0, i64 0)), !dbg !1275
  %add.ptr30 = getelementptr inbounds i8, i8* %call1, i64 1, !dbg !1276
  call void (i8*, ...) @die_errno(i8* %call29, i8* %2, i8* %add.ptr30) #8, !dbg !1277
  unreachable, !dbg !1277

if.end31:                                         ; preds = %if.end
  %call32 = call i32 @split_cmdline(i8* %call1, i8*** %new_argv), !dbg !1278
...
if.then35:                                        ; preds = %if.end31
  %call36 = call i8* @_(i8* getelementptr inbounds ([24 x i8], [24 x i8]* @.str.244, i64 0, i64 0)), !dbg !1284
  %17 = load i32, i32* %count, align 4, !dbg !1285
  %call37 = call i8* @split_cmdline_strerror(i32 %17), !dbg !1286
  %call38 = call i8* @_(i8* %call37), !dbg !1287
  call void (i8*, ...) @die(i8* %call36, i8* %2, i8* %call38) #8, !dbg !1288
  unreachable, !dbg !1288

if.end39:                                         ; preds = %if.end31
  %call40 = call i32 @handle_options(i8*** %new_argv, i32* %count, i32* %envchanged), !dbg !1289
...
if.then42:                                        ; preds = %if.end39
  %call43 = call i8* @_(i8* getelementptr inbounds ([85 x i8], [85 x i8]* @.str.245, i64 0, i64 0)), !dbg !1294
  call void (i8*, ...) @die(i8* %call43, i8* %2) #8, !dbg !1295
...
if.end44:                                         ; preds = %if.end39
  ...
  call void @move_array(i8* %20, i8* %22, i64 %conv46, i64 8), !dbg !1296
...
if.then52:                                        ; preds = %if.end44
  %call53 = call i8* @_(i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.246, i64 0, i64 0)), !dbg !1302
  call void (i8*, ...) @die(i8* %call53, i8* %2) #8, !dbg !1303
...
if.end54:                                         ; preds = %if.end44
  ...
  %call56 = call i32 @strcmp(i8* %2, i8* %27), !dbg !1306
  %tobool57 = icmp ne i32 %call56, 0, !dbg !1306
  br i1 %tobool57, label %if.end60, label %if.then58, !dbg !1307

if.then58:                                        ; preds = %if.end54
  %call59 = call i8* @_(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.247, i64 0, i64 0)), !dbg !1308
  call void (i8*, ...) @die(i8* %call59, i8* %2) #8, !dbg !1309
...
do.body:                                          ; preds = %if.end60
  %call61 = call i32 @trace_pass_fl(%struct.trace_key* @trace_default_key), !dbg !1311
...
if.then63:                                        ; preds = %do.body
  ...
  call void (i8*, i32, i8**, i8*, ...) @trace_argv_printf_fl(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 399, i8** %28, i8* getelementptr inbounds ([30 x i8], [30 x i8]* @.str.248, i64 0, i64 0), i8* %2), !dbg !1311
...
do.end:                                           ; preds = %if.end64
  ...
  %call66 = call i64 @st_mult(i64 8, i64 %conv65), !dbg !1315
  %call67 = call i8* @xrealloc(i8* %30, i64 %call66), !dbg !1315
  ...
  call void @copy_array(i8* %36, i8* %38, i64 %conv71, i64 8), !dbg !1316
  %40 = load i8**, i8*** %new_argv, align 8, !dbg !1317
  call void @trace2_cmd_alias_fl(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 405, i8* %2, i8** %40), !dbg !1317
  call void @trace2_cmd_list_config_fl(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 406), !dbg !1318
  call void @trace2_cmd_list_env_vars_fl(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 407), !dbg !1319
...
; Function Attrs: noinline nounwind ssp uwtable
define internal void @move_array(i8* %dst, i8* %src, i64 %n, i64 %size) #0 !dbg !1329 {
entry:
...
if.then:                                          ; preds = %entry
  %call = call i64 @st_mult(i64 %size, i64 %n), !dbg !1342
  %0 = call i64 @llvm.objectsize.i64.p0i8(i8* %dst, i1 false, i1 true, i1 false), !dbg !1342
  %call1 = call i8* @__memmove_chk(i8* %dst, i8* %src, i64 %call, i64 %0) #9, !dbg !1342
...
; Function Attrs: noinline nounwind ssp uwtable
define internal i64 @st_mult(i64 %a, i64 %b) #0 !dbg !1344 {
entry:
...
if.then:                                          ; preds = %land.lhs.true
  call void (i8*, ...) @die(i8* getelementptr inbounds ([27 x i8], [27 x i8]* @.str.249, i64 0, i64 0), i64 %a, i64 %b) #8, !dbg !1353
...
; Function Attrs: noinline nounwind ssp uwtable
define internal void @copy_array(i8* %dst, i8* %src, i64 %n, i64 %size) #0 !dbg !1356 {
entry:
...
if.then:                                          ; preds = %entry
  %call = call i64 @st_mult(i64 %size, i64 %n), !dbg !1365
  %0 = call i64 @llvm.objectsize.i64.p0i8(i8* %dst, i1 false, i1 true, i1 false), !dbg !1365
  %call1 = call i8* @__memcpy_chk(i8* %dst, i8* %src, i64 %call, i64 %0) #9, !dbg !1365
...
; Function Attrs: noinline nounwind ssp uwtable
define internal void @list_builtins(%struct.string_list* %out, i32 %exclude_option) #0 !dbg !1367 {
entry:
...
if.end:                                           ; preds = %land.lhs.true, %for.body
  ...
  %call = call %struct.string_list_item* @string_list_append(%struct.string_list* %out, i8* %1), !dbg !1393
...
; Function Attrs: noinline nounwind ssp uwtable
define internal i32 @list_cmds(i8* %spec) #0 !dbg !1400 {
entry:
  %list = alloca %struct.string_list, align 8
  ...
  %call = call i8* @setup_git_directory_gently(i32* %nongit), !dbg !1407
...
while.body:                                       ; preds = %while.cond
  %call1 = call i8* @gitstrchrnul(i8* %spec.addr.0, i32 44), !dbg !1410
  ...
  %call2 = call i32 @match_token(i8* %spec.addr.0, i32 %conv, i8* getelementptr inbounds ([9 x i8], [9 x i8]* @.str.220, i64 0, i64 0)), !dbg !1417
  %tobool3 = icmp ne i32 %call2, 0, !dbg !1417
  br i1 %tobool3, label %if.then, label %if.else, !dbg !1419

if.then:                                          ; preds = %while.body
  call void @list_builtins(%struct.string_list* %list, i32 0), !dbg !1420
  br label %if.end36, !dbg !1420

if.else:                                          ; preds = %while.body
  %call4 = call i32 @match_token(i8* %spec.addr.0, i32 %conv, i8* getelementptr inbounds ([5 x i8], [5 x i8]* @.str.221, i64 0, i64 0)), !dbg !1421
  %tobool5 = icmp ne i32 %call4, 0, !dbg !1421
  br i1 %tobool5, label %if.then6, label %if.else7, !dbg !1423

if.then6:                                         ; preds = %if.else
  call void @list_all_main_cmds(%struct.string_list* %list), !dbg !1424
  br label %if.end35, !dbg !1424

if.else7:                                         ; preds = %if.else
  %call8 = call i32 @match_token(i8* %spec.addr.0, i32 %conv, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.222, i64 0, i64 0)), !dbg !1425
  %tobool9 = icmp ne i32 %call8, 0, !dbg !1425
  br i1 %tobool9, label %if.then10, label %if.else11, !dbg !1427

if.then10:                                        ; preds = %if.else7
  call void @list_all_other_cmds(%struct.string_list* %list), !dbg !1428
  br label %if.end34, !dbg !1428

if.else11:                                        ; preds = %if.else7
  %call12 = call i32 @match_token(i8* %spec.addr.0, i32 %conv, i8* getelementptr inbounds ([10 x i8], [10 x i8]* @.str.223, i64 0, i64 0)), !dbg !1429
  %tobool13 = icmp ne i32 %call12, 0, !dbg !1429
  br i1 %tobool13, label %if.then14, label %if.else15, !dbg !1431

if.then14:                                        ; preds = %if.else11
  call void @exclude_helpers_from_list(%struct.string_list* %list), !dbg !1432
  br label %if.end33, !dbg !1432

if.else15:                                        ; preds = %if.else11
  %call16 = call i32 @match_token(i8* %spec.addr.0, i32 %conv, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.224, i64 0, i64 0)), !dbg !1433
  %tobool17 = icmp ne i32 %call16, 0, !dbg !1433
  br i1 %tobool17, label %if.then18, label %if.else19, !dbg !1435

if.then18:                                        ; preds = %if.else15
  call void @list_aliases(%struct.string_list* %list), !dbg !1436
  br label %if.end32, !dbg !1436

if.else19:                                        ; preds = %if.else15
  %call20 = call i32 @match_token(i8* %spec.addr.0, i32 %conv, i8* getelementptr inbounds ([7 x i8], [7 x i8]* @.str.43, i64 0, i64 0)), !dbg !1437
  %tobool21 = icmp ne i32 %call20, 0, !dbg !1437
  br i1 %tobool21, label %if.then22, label %if.else23, !dbg !1439

if.then22:                                        ; preds = %if.else19
  call void @list_cmds_by_config(%struct.string_list* %list), !dbg !1440
...
land.lhs.true:                                    ; preds = %if.else23
  %call25 = call i32 @strncmp(i8* %spec.addr.0, i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.225, i64 0, i64 0), i64 5), !dbg !1444
...
if.then27:                                        ; preds = %land.lhs.true
  ...
  call void @strbuf_add(%struct.strbuf* %sb, i8* %add.ptr, i64 %conv28), !dbg !1452
  %buf = getelementptr inbounds %struct.strbuf, %struct.strbuf* %sb, i32 0, i32 2, !dbg !1453
  %5 = load i8*, i8** %buf, align 8, !dbg !1453
  call void @list_cmds_by_category(%struct.string_list* %list, i8* %5), !dbg !1454
  call void @strbuf_release(%struct.strbuf* %sb), !dbg !1455
  br label %if.end, !dbg !1456

if.else29:                                        ; preds = %land.lhs.true, %if.else23
  %call30 = call i8* @_(i8* getelementptr inbounds ([38 x i8], [38 x i8]* @.str.226, i64 0, i64 0)), !dbg !1457
  call void (i8*, ...) @die(i8* %call30, i8* %spec.addr.0) #8, !dbg !1458
...
for.body:                                         ; preds = %for.cond
  ...
  %call46 = call i32 @puts(i8* %9), !dbg !1480
...
for.end:                                          ; preds = %for.cond
  call void @string_list_clear(%struct.string_list* %list, i32 0), !dbg !1485
  ret i32 0, !dbg !1486
}

; Function Attrs: noinline nounwind ssp uwtable
define internal i8* @gitstrchrnul(i8* %s, i32 %c) #0 !dbg !1487 {
entry:
...
; Function Attrs: noinline nounwind ssp uwtable
define internal i32 @match_token(i8* %spec, i32 %len, i8* %token) #0 !dbg !1501 {
entry:
  ...
  %call = call i64 @strlen(i8* %token), !dbg !1508
...
land.rhs:                                         ; preds = %entry
  ...
  %call3 = call i32 @strncmp(i8* %spec, i8* %token, i64 %conv2), !dbg !1513
...
; Function Attrs: noinline nounwind ssp uwtable
define internal void @exclude_helpers_from_list(%struct.string_list* %list) #0 !dbg !1516 {
entry:
...
while.body:                                       ; preds = %while.cond
  ...
  %call = call i8* @strstr(i8* %2, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.227, i64 0, i64 0)), !dbg !1532
  %tobool = icmp ne i8* %call, null, !dbg !1532
  br i1 %tobool, label %if.then, label %if.else, !dbg !1533

if.then:                                          ; preds = %while.body
  call void @unsorted_string_list_delete_item(%struct.string_list* %list, i32 %i.0, i32 0), !dbg !1534
...
; Function Attrs: noinline nounwind ssp uwtable
define internal i32 @run_builtin(%struct.cmd_struct* %p, i32 %argc, i8** %argv) #0 !dbg !1539 {
entry:
...
land.rhs:                                         ; preds = %entry
  ...
  %call = call i32 @strcmp(i8* %1, i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.11, i64 0, i64 0)), !dbg !1615
...
if.then10:                                        ; preds = %if.else
  ...
  %call11 = call i8* @setup_git_directory_gently(i32* %nongit_ok), !dbg !1637
...
cond.true:                                        ; preds = %lor.end
  call void @__assert_rtn(i8* getelementptr inbounds ([12 x i8], [12 x i8]* @__func__.run_builtin, i64 0, i64 0), i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 440, i8* getelementptr inbounds ([19 x i8], [19 x i8]* @.str.157, i64 0, i64 0)) #10, !dbg !1641
...
cond.end:                                         ; preds = %cond.false, %5
  %call20 = call i8* @precompose_argv_prefix(i32 %argc, i8** %argv, i8* null), !dbg !1642
...
if.then29:                                        ; preds = %land.lhs.true25
  ...
  %call30 = call i32 @check_pager_config(i8* %8), !dbg !1653
...
if.then43:                                        ; preds = %land.lhs.true41
  call void @trace_repo_setup(i8* %prefix.1), !dbg !1671
...
if.then53:                                        ; preds = %if.then49
  %call54 = call i8* @_(i8* getelementptr inbounds ([34 x i8], [34 x i8]* @.str.158, i64 0, i64 0)), !dbg !1683
  ...
  call void (i8*, ...) @die(i8* %call54, i8* %14) #8, !dbg !1685
...
do.body:                                          ; preds = %if.end64
  %call65 = call i32 @trace_pass_fl(%struct.trace_key* @trace_default_key), !dbg !1695
  %tobool66 = icmp ne i32 %call65, 0, !dbg !1695
  br i1 %tobool66, label %if.then67, label %if.end68, !dbg !1698

if.then67:                                        ; preds = %do.body
  call void (i8*, i32, i8**, i8*, ...) @trace_argv_printf_fl(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 460, i8** %argv, i8* getelementptr inbounds ([21 x i8], [21 x i8]* @.str.159, i64 0, i64 0)), !dbg !1695
...
do.end:                                           ; preds = %if.end68
  ...
  call void @trace2_cmd_name_fl(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 461, i8* %16), !dbg !1699
  call void @trace2_cmd_list_config_fl(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 462), !dbg !1700
  call void @trace2_cmd_list_env_vars_fl(i8* getelementptr inbounds ([6 x i8], [6 x i8]* @.str.1, i64 0, i64 0), i32 463), !dbg !1701
  ...
  call void @validate_cache_entries(%struct.index_state* %18), !dbg !1704
  ...
  %call70 = call i32 %19(i32 %argc, i8** %argv, i8* %prefix.1), !dbg !1706
  ...
  call void @validate_cache_entries(%struct.index_state* %21), !dbg !1710
...
if.end74:                                         ; preds = %do.end
  ...
  %call75 = call i32 @fileno(%struct.__sFILE* %22), !dbg !1717
  %call76 = call i32 @"\01_fstat$INODE64"(i32 %call75, %struct.stat* %st), !dbg !1718
...
if.end90:                                         ; preds = %lor.lhs.false
  ...
  %call91 = call i32 @fflush(%struct.__sFILE* %25), !dbg !1729
  %tobool92 = icmp ne i32 %call91, 0, !dbg !1729
  br i1 %tobool92, label %if.then93, label %if.end95, !dbg !1730

if.then93:                                        ; preds = %if.end90
  %call94 = call i8* @_(i8* getelementptr inbounds ([33 x i8], [33 x i8]* @.str.160, i64 0, i64 0)), !dbg !1731
  call void (i8*, ...) @die_errno(i8* %call94) #8, !dbg !1732
  unreachable, !dbg !1732

if.end95:                                         ; preds = %if.end90
  %26 = load %struct.__sFILE*, %struct.__sFILE** @__stdoutp, align 8, !dbg !1733
  %call96 = call i32 @ferror(%struct.__sFILE* %26), !dbg !1735
  %tobool97 = icmp ne i32 %call96, 0, !dbg !1735
  br i1 %tobool97, label %if.then98, label %if.end100, !dbg !1736

if.then98:                                        ; preds = %if.end95
  %call99 = call i8* @_(i8* getelementptr inbounds ([41 x i8], [41 x i8]* @.str.161, i64 0, i64 0)), !dbg !1737
  call void (i8*, ...) @die(i8* %call99) #8, !dbg !1738
  unreachable, !dbg !1738

if.end100:                                        ; preds = %if.end95
  %27 = load %struct.__sFILE*, %struct.__sFILE** @__stdoutp, align 8, !dbg !1739
  %call101 = call i32 @fclose(%struct.__sFILE* %27), !dbg !1741
  %tobool102 = icmp ne i32 %call101, 0, !dbg !1741
  br i1 %tobool102, label %if.then103, label %if.end105, !dbg !1742

if.then103:                                       ; preds = %if.end100
  %call104 = call i8* @_(i8* getelementptr inbounds ([32 x i8], [32 x i8]* @.str.162, i64 0, i64 0)), !dbg !1743
  call void (i8*, ...) @die_errno(i8* %call104) #8, !dbg !1744
...
!55 = distinct !DILexicalBlock(scope: !48, file: !3, line: 127, column: 6)
...
!59 = !DILocation(line: 127, column: 6, scope: !48)
!60 = !DILocation(line: 128, column: 3, scope: !55)
!61 = !DILocation(line: 129, column: 14, scope: !48)
!62 = !DILocation(line: 129, column: 12, scope: !48)
!63 = !DILocation(line: 130, column: 6, scope: !64)
!64 = distinct !DILexicalBlock(scope: !48, file: !3, line: 130, column: 6)
!65 = !DILocation(line: 130, column: 16, scope: !64)
!66 = !DILocation(line: 130, column: 6, scope: !48)
!67 = !DILocation(line: 131, column: 13, scope: !64)
!68 = !DILocation(line: 131, column: 3, scope: !64)
!69 = !DILocation(line: 132, column: 2, scope: !48)
!70 = !DILocation(line: 133, column: 1, scope: !48)
!71 = distinct !DISubprogram(name: "commit_pager_choice", scope: !3, file: !3, line: 111, type: !72, scopeLine: 112, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !4)
...
!83 = distinct !DISubprogram(name: "is_builtin", scope: !3, file: !3, line: 646, type: !84, scopeLine: 647, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !4)
!84 = !DISubroutineType(types: !85)
!85 = !{!20, !27}
!86 = !DILocalVariable(name: "s", arg: 1, scope: !83, file: !3, line: 646, type: !27)
...
!92 = distinct !DISubprogram(name: "get_builtin", scope: !3, file: !3, line: 635, type: !93, scopeLine: 636, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !4)
!93 = !DISubroutineType(types: !94)
!94 = !{!95, !27}
!95 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !24, size: 64)
!96 = !DILocalVariable(name: "s", arg: 1, scope: !92, file: !3, line: 635, type: !27)
!97 = !DILocation(line: 0, scope: !92)
!98 = !DILocalVariable(name: "i", scope: !92, file: !3, line: 637, type: !20)
...
!123 = distinct !DISubprogram(name: "load_builtin_commands", scope: !3, file: !3, line: 662, type: !124, scopeLine: 663, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !4)
...
!129 = !{!130, !131, !132}
!130 = !DIDerivedType(tag: DW_TAG_member, name: "alloc", scope: !127, file: !128, line: 8, baseType: !20, size: 32)
!131 = !DIDerivedType(tag: DW_TAG_member, name: "cnt", scope: !127, file: !128, line: 9, baseType: !20, size: 32, offset: 32)
...
!140 = !DIDerivedType(tag: DW_TAG_typedef, name: "__darwin_size_t", file: !141, line: 94, baseType: !10)
...
!143 = !DICompositeType(tag: DW_TAG_array_type, baseType: !7, elements: !144)
!144 = !{!145}
!145 = !DISubrange(count: -1)
!146 = !DILocalVariable(name: "prefix", arg: 1, scope: !123, file: !3, line: 662, type: !27)
...
!150 = !DILocalVariable(name: "name", scope: !123, file: !3, line: 664, type: !27)
...
!157 = !DILocalVariable(name: "i", scope: !123, file: !3, line: 665, type: !20)
...
!181 = distinct !DISubprogram(name: "skip_prefix", scope: !182, file: !182, line: 674, type: !183, scopeLine: 676, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !4)
!182 = !DIFile(filename: "./git-compat-util.h", directory: "/Users/jryans/Projects/git")
!183 = !DISubroutineType(types: !184)
!184 = !{!20, !27, !27, !32}
!185 = !DILocalVariable(name: "str", arg: 1, scope: !181, file: !182, line: 674, type: !27)
!186 = !DILocation(line: 0, scope: !181)
!187 = !DILocalVariable(name: "prefix", arg: 2, scope: !181, file: !182, line: 674, type: !27)
!188 = !DILocalVariable(name: "out", arg: 3, scope: !181, file: !182, line: 675, type: !32)
...
!207 = distinct !DISubprogram(name: "cmd_main", scope: !3, file: !3, line: 864, type: !208, scopeLine: 865, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !2, retainedNodes: !4)
!208 = !DISubroutineType(types: !209)
!209 = !{!20, !20, !32}
!210 = !DILocalVariable(name: "argc", arg: 1, scope: !207, file: !3, line: 864, type: !20)
!211 = !DILocation(line: 864, column: 18, scope: !207)
!212 = !DILocalVariable(name: "argv", arg: 2, scope: !207, file: !3, line: 864, type: !32)
!213 = !DILocation(line: 864, column: 37, scope: !207)
!214 = !DILocalVariable(name: "cmd", scope: !207, file: !3, line: 866, type: !27)
!215 = !DILocation(line: 866, column: 14, scope: !207)
!216 = !DILocalVariable(name: "done_help", scope: !207, file: !3, line: 867, type: !20)
...
!228 = !DILocalVariable(name: "slash", scope: !226, file: !3, line: 873, type: !27)
...
!290 = !DILocalVariable(name: "was_alias", scope: !289, file: !3, line: 926, type: !20)
...
!327 = distinct !DISubprogram(name: "git_find_last_dir_sep", scope: !182, file: !182, line: 536, type: !328, scopeLine: 537, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !4)
!328 = !DISubroutineType(types: !329)
!329 = !{!6, !27}
!330 = !DILocalVariable(name: "path", arg: 1, scope: !327, file: !182, line: 536, type: !27)
!331 = !DILocation(line: 0, scope: !327)
!332 = !DILocation(line: 538, column: 9, scope: !327)
!333 = !DILocation(line: 538, column: 2, scope: !327)
!334 = distinct !DISubprogram(name: "handle_builtin", scope: !3, file: !3, line: 693, type: !335, scopeLine: 694, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !4)
!335 = !DISubroutineType(types: !336)
!336 = !{null, !20, !32}
!337 = !DILocalVariable(name: "argc", arg: 1, scope: !334, file: !3, line: 693, type: !20)
!338 = !DILocation(line: 0, scope: !334)
!339 = !DILocalVariable(name: "argv", arg: 2, scope: !334, file: !3, line: 693, type: !32)
...
!343 = !{!344, !345, !346}
!344 = !DIDerivedType(tag: DW_TAG_member, name: "v", scope: !341, file: !342, line: 31, baseType: !32, size: 64)
...
!349 = !DILocalVariable(name: "cmd", scope: !334, file: !3, line: 696, type: !27)
...
!362 = !DILocalVariable(name: "i", scope: !357, file: !3, line: 704, type: !20)
...
!393 = distinct !DISubprogram(name: "_", scope: !394, file: !394, line: 44, type: !395, scopeLine: 45, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !4)
!394 = !DIFile(filename: "./gettext.h", directory: "/Users/jryans/Projects/git")
!395 = !DISubroutineType(types: !396)
!396 = !{!27, !27}
!397 = !DILocalVariable(name: "msgid", arg: 1, scope: !393, file: !394, line: 44, type: !27)
...
!406 = distinct !DISubprogram(name: "handle_options", scope: !3, file: !3, line: 135, type: !407, scopeLine: 136, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !4)
!407 = !DISubroutineType(types: !408)
!408 = !{!20, !409, !410, !410}
!409 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !32, size: 64)
!410 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !20, size: 64)
...
!416 = !DILocalVariable(name: "orig_argv", scope: !406, file: !3, line: 137, type: !32)
...
!420 = !DILocalVariable(name: "cmd", scope: !421, file: !3, line: 140, type: !27)
...
!686 = !DILocalVariable(name: "cwd", scope: !685, file: !3, line: 244, type: !6)
...
!889 = !{!890, !891}
!890 = !DIDerivedType(tag: DW_TAG_member, name: "string", scope: !888, file: !884, line: 69, baseType: !6, size: 64)
...
!895 = !DIDerivedType(tag: DW_TAG_member, name: "strdup_strings", scope: !883, file: !884, line: 91, baseType: !34, size: 1, offset: 192, flags: DIFlagBitField, extraData: i64 192)
...
!903 = !DILocalVariable(name: "i", scope: !882, file: !3, line: 316, type: !20)
...
!939 = distinct !DISubprogram(name: "run_argv", scope: !3, file: !3, line: 771, type: !940, scopeLine: 772, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !4)
...
!945 = !DILocalVariable(name: "done_alias", scope: !939, file: !3, line: 773, type: !20)
...
!973 = !DIDerivedType(tag: DW_TAG_typedef, name: "__int32_t", file: !141, line: 46, baseType: !20)
!974 = !DIDerivedType(tag: DW_TAG_member, name: "trace2_child_id", scope: !963, file: !964, line: 79, baseType: !20, size: 32, offset: 416)
...
!979 = !DIDerivedType(tag: DW_TAG_member, name: "trace2_child_class", scope: !963, file: !964, line: 81, baseType: !27, size: 64, offset: 512)
!980 = !DIDerivedType(tag: DW_TAG_member, name: "trace2_hook_name", scope: !963, file: !964, line: 82, baseType: !27, size: 64, offset: 576)
!981 = !DIDerivedType(tag: DW_TAG_member, name: "in", scope: !963, file: !964, line: 102, baseType: !20, size: 32, offset: 640)
!982 = !DIDerivedType(tag: DW_TAG_member, name: "out", scope: !963, file: !964, line: 103, baseType: !20, size: 32, offset: 672)
!983 = !DIDerivedType(tag: DW_TAG_member, name: "err", scope: !963, file: !964, line: 104, baseType: !20, size: 32, offset: 704)
!984 = !DIDerivedType(tag: DW_TAG_member, name: "dir", scope: !963, file: !964, line: 110, baseType: !27, size: 64, offset: 768)
!985 = !DIDerivedType(tag: DW_TAG_member, name: "no_stdin", scope: !963, file: !964, line: 112, baseType: !34, size: 1, offset: 832, flags: DIFlagBitField, extraData: i64 832)
!986 = !DIDerivedType(tag: DW_TAG_member, name: "no_stdout", scope: !963, file: !964, line: 113, baseType: !34, size: 1, offset: 833, flags: DIFlagBitField, extraData: i64 832)
!987 = !DIDerivedType(tag: DW_TAG_member, name: "no_stderr", scope: !963, file: !964, line: 114, baseType: !34, size: 1, offset: 834, flags: DIFlagBitField, extraData: i64 832)
!988 = !DIDerivedType(tag: DW_TAG_member, name: "git_cmd", scope: !963, file: !964, line: 115, baseType: !34, size: 1, offset: 835, flags: DIFlagBitField, extraData: i64 832)
!989 = !DIDerivedType(tag: DW_TAG_member, name: "silent_exec_failure", scope: !963, file: !964, line: 123, baseType: !34, size: 1, offset: 836, flags: DIFlagBitField, extraData: i64 832)
!990 = !DIDerivedType(tag: DW_TAG_member, name: "use_shell", scope: !963, file: !964, line: 131, baseType: !34, size: 1, offset: 837, flags: DIFlagBitField, extraData: i64 832)
!991 = !DIDerivedType(tag: DW_TAG_member, name: "close_object_store", scope: !963, file: !964, line: 139, baseType: !34, size: 1, offset: 838, flags: DIFlagBitField, extraData: i64 832)
!992 = !DIDerivedType(tag: DW_TAG_member, name: "stdout_to_stderr", scope: !963, file: !964, line: 141, baseType: !34, size: 1, offset: 839, flags: DIFlagBitField, extraData: i64 832)
!993 = !DIDerivedType(tag: DW_TAG_member, name: "clean_on_exit", scope: !963, file: !964, line: 142, baseType: !34, size: 1, offset: 840, flags: DIFlagBitField, extraData: i64 832)
!994 = !DIDerivedType(tag: DW_TAG_member, name: "wait_after_clean", scope: !963, file: !964, line: 143, baseType: !34, size: 1, offset: 841, flags: DIFlagBitField, extraData: i64 832)
...
!1011 = !DILocalVariable(name: "i", scope: !962, file: !3, line: 791, type: !20)
...
!1068 = !DIDerivedType(tag: DW_TAG_member, name: "buf", scope: !1063, file: !1064, line: 69, baseType: !6, size: 64, offset: 128)
!1069 = !DILocation(line: 833, column: 18, scope: !1062)
!1070 = !DILocalVariable(name: "i", scope: !1062, file: !3, line: 832, type: !20)
...
!1120 = distinct !DISubprogram(name: "trace_pass_fl", scope: !1121, file: !1121, line: 273, type: !1122, scopeLine: 274, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !4)
...
!1128 = !DIDerivedType(tag: DW_TAG_const_type, baseType: !27)
!1129 = !DIDerivedType(tag: DW_TAG_member, name: "fd", scope: !1125, file: !1121, line: 85, baseType: !20, size: 32, offset: 64)
!1130 = !DIDerivedType(tag: DW_TAG_member, name: "initialized", scope: !1125, file: !1121, line: 86, baseType: !34, size: 1, offset: 96, flags: DIFlagBitField, extraData: i64 96)
!1131 = !DIDerivedType(tag: DW_TAG_member, name: "need_close", scope: !1125, file: !1121, line: 87, baseType: !34, size: 1, offset: 97, flags: DIFlagBitField, extraData: i64 96)
...
!1140 = distinct !DISubprogram(name: "execv_dashed_external", scope: !3, file: !3, line: 725, type: !1141, scopeLine: 726, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !4)
!1141 = !DISubroutineType(types: !1142)
!1142 = !{null, !32}
!1143 = !DILocalVariable(name: "argv", arg: 1, scope: !1140, file: !3, line: 725, type: !32)
...
!1186 = !DILocalVariable(name: "status", scope: !1140, file: !3, line: 728, type: !20)
...
!1197 = distinct !DISubprogram(name: "strbuf_addstr", scope: !1064, file: !1064, line: 303, type: !1198, scopeLine: 304, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !4)
...
!1203 = !DILocalVariable(name: "s", arg: 2, scope: !1197, file: !1064, line: 303, type: !27)
...
!1207 = distinct !DISubprogram(name: "handle_alias", scope: !3, file: !3, line: 337, type: !940, scopeLine: 338, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !4)
...
!1211 = !DILocalVariable(name: "envchanged", scope: !1207, file: !3, line: 339, type: !20)
!1212 = !DILocation(line: 339, column: 6, scope: !1207)
!1213 = !DILocalVariable(name: "ret", scope: !1207, file: !3, line: 339, type: !20)
!1214 = !DILocation(line: 339, column: 45, scope: !1207)
!1215 = !DILocalVariable(name: "saved_errno", scope: !1207, file: !3, line: 339, type: !20)
!1216 = !DILocalVariable(name: "count", scope: !1207, file: !3, line: 340, type: !20)
!1217 = !DILocation(line: 340, column: 6, scope: !1207)
!1218 = !DILocalVariable(name: "new_argv", scope: !1207, file: !3, line: 341, type: !32)
...
!1222 = !DILocalVariable(name: "alias_command", scope: !1207, file: !3, line: 342, type: !27)
!1223 = !DILocation(line: 346, column: 17, scope: !1207)
!1224 = !DILocalVariable(name: "alias_string", scope: !1207, file: !3, line: 343, type: !6)
...
!1247 = !DILocalVariable(name: "nongit_ok", scope: !1245, file: !3, line: 353, type: !20)
...
!1290 = !DILocalVariable(name: "option_count", scope: !1207, file: !3, line: 340, type: !20)
...
!1329 = distinct !DISubprogram(name: "move_array", scope: !182, file: !182, line: 1104, type: !1330, scopeLine: 1105, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !4)
...
!1344 = distinct !DISubprogram(name: "st_mult", scope: !182, file: !182, line: 990, type: !1345, scopeLine: 991, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !4)
...
!1356 = distinct !DISubprogram(name: "copy_array", scope: !182, file: !182, line: 1096, type: !1330, scopeLine: 1097, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !4)
...
!1367 = distinct !DISubprogram(name: "list_builtins", scope: !3, file: !3, line: 651, type: !1368, scopeLine: 652, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !4)
...
!1373 = !DILocalVariable(name: "exclude_option", arg: 2, scope: !1367, file: !3, line: 651, type: !34)
!1374 = !DILocalVariable(name: "i", scope: !1367, file: !3, line: 653, type: !20)
...
!1400 = distinct !DISubprogram(name: "list_cmds", scope: !3, file: !3, line: 64, type: !84, scopeLine: 65, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !4)
!1401 = !DILocalVariable(name: "spec", arg: 1, scope: !1400, file: !3, line: 64, type: !27)
...
!1405 = !DILocalVariable(name: "nongit", scope: !1400, file: !3, line: 68, type: !20)
...
!1412 = !DILocalVariable(name: "sep", scope: !1411, file: !3, line: 77, type: !27)
...
!1416 = !DILocalVariable(name: "len", scope: !1411, file: !3, line: 78, type: !20)
...
!1468 = !DILocalVariable(name: "i", scope: !1400, file: !3, line: 67, type: !20)
...
!1487 = distinct !DISubprogram(name: "gitstrchrnul", scope: !182, file: !182, line: 959, type: !1488, scopeLine: 960, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !4)
!1488 = !DISubroutineType(types: !1489)
!1489 = !{!6, !27, !20}
!1490 = !DILocalVariable(name: "s", arg: 1, scope: !1487, file: !182, line: 959, type: !27)
!1491 = !DILocation(line: 0, scope: !1487)
!1492 = !DILocalVariable(name: "c", arg: 2, scope: !1487, file: !182, line: 959, type: !20)
...
!1501 = distinct !DISubprogram(name: "match_token", scope: !3, file: !3, line: 57, type: !1502, scopeLine: 58, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !4)
!1502 = !DISubroutineType(types: !1503)
!1503 = !{!20, !27, !20, !27}
!1504 = !DILocalVariable(name: "spec", arg: 1, scope: !1501, file: !3, line: 57, type: !27)
!1505 = !DILocation(line: 0, scope: !1501)
!1506 = !DILocalVariable(name: "len", arg: 2, scope: !1501, file: !3, line: 57, type: !20)
!1507 = !DILocalVariable(name: "token", arg: 3, scope: !1501, file: !3, line: 57, type: !27)
!1508 = !DILocation(line: 59, column: 18, scope: !1501)
!1509 = !DILocalVariable(name: "token_len", scope: !1501, file: !3, line: 59, type: !20)
...
!1516 = distinct !DISubprogram(name: "exclude_helpers_from_list", scope: !3, file: !3, line: 45, type: !1517, scopeLine: 46, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !4)
!1517 = !DISubroutineType(types: !1518)
!1518 = !{null, !1370}
!1519 = !DILocalVariable(name: "list", arg: 1, scope: !1516, file: !3, line: 45, type: !1370)
!1520 = !DILocation(line: 0, scope: !1516)
!1521 = !DILocalVariable(name: "i", scope: !1516, file: !3, line: 47, type: !20)
...
!1539 = distinct !DISubprogram(name: "run_builtin", scope: !3, file: !3, line: 420, type: !1540, scopeLine: 421, flags: DIFlagPrototyped, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !2, retainedNodes: !4)
!1540 = !DISubroutineType(types: !1541)
!1541 = !{!20, !95, !20, !32}
!1542 = !DILocalVariable(name: "p", arg: 1, scope: !1539, file: !3, line: 420, type: !95)
!1543 = !DILocation(line: 0, scope: !1539)
!1544 = !DILocalVariable(name: "argc", arg: 2, scope: !1539, file: !3, line: 420, type: !20)
!1545 = !DILocalVariable(name: "argv", arg: 3, scope: !1539, file: !3, line: 420, type: !32)
...
!1570 = !DIDerivedType(tag: DW_TAG_typedef, name: "__uint32_t", file: !141, line: 47, baseType: !34)
...
!1611 = !DILocalVariable(name: "run_setup", scope: !1539, file: !3, line: 425, type: !20)
...
!1617 = !DILocalVariable(name: "help", scope: !1539, file: !3, line: 422, type: !20)
...
!1629 = !DILocalVariable(name: "prefix", scope: !1539, file: !3, line: 424, type: !27)
...
!1634 = !DILocalVariable(name: "nongit_ok", scope: !1635, file: !3, line: 435, type: !20)
...
!1707 = !DILocalVariable(name: "status", scope: !1539, file: !3, line: 422, type: !20)
