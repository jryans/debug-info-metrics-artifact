...
make clean
git clean -f
# TODO: Might need to clean more (remove `gnu` directory)...?
# Seems possibly okay, files generated by GNU Bison
# Also contains compilation output of those files, but appears to get
